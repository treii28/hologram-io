...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.GetAlertCountbyTyperesponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The GetAlertCountbyTyperesponse model module.
   * @module model/GetAlertCountbyTyperesponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>GetAlertCountbyTyperesponse</code>.
   * @alias module:model/GetAlertCountbyTyperesponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetAlertCountbyTyperesponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetAlertCountbyTyperesponse} obj Optional instance to populate.
   * @return {module:model/GetAlertCountbyTyperesponse} The populated <code>GetAlertCountbyTyperesponse</code> instance.
   */
  ...
  /**
   * Number of alerts for given alert type
   * @member {Number} data
   */
