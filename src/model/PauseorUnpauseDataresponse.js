...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Data3'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Data3'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.PauseorUnpauseDataresponse = factory(root.Hologram.ApiClient, root.Hologram.Data3);
  }
}(this, function(ApiClient, Data3) {
  'use strict';

  /**
   * The PauseorUnpauseDataresponse model module.
   * @module model/PauseorUnpauseDataresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>PauseorUnpauseDataresponse</code>.
   * @alias module:model/PauseorUnpauseDataresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>PauseorUnpauseDataresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PauseorUnpauseDataresponse} obj Optional instance to populate.
   * @return {module:model/PauseorUnpauseDataresponse} The populated <code>PauseorUnpauseDataresponse</code> instance.
   */
