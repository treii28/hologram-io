...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Data4'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Data4'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.ListAllRecentDataSessionsresponse = factory(root.Hologram.ApiClient, root.Hologram.Data4);
  }
}(this, function(ApiClient, Data4) {
  'use strict';

  /**
   * The ListAllRecentDataSessionsresponse model module.
   * @module model/ListAllRecentDataSessionsresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListAllRecentDataSessionsresponse</code>.
   * @alias module:model/ListAllRecentDataSessionsresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAllRecentDataSessionsresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAllRecentDataSessionsresponse} obj Optional instance to populate.
   * @return {module:model/ListAllRecentDataSessionsresponse} The populated <code>ListAllRecentDataSessionsresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [Data4]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Data4>} data
   */
