...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ActivateMultipleSIMsbyICCIDrequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ActivateMultipleSIMsbyICCIDrequest model module.
   * @module model/ActivateMultipleSIMsbyICCIDrequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>ActivateMultipleSIMsbyICCIDrequest</code>.
   * @alias module:model/ActivateMultipleSIMsbyICCIDrequest
   * @class
   */
  ...
  /**
   * Constructs a <code>ActivateMultipleSIMsbyICCIDrequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActivateMultipleSIMsbyICCIDrequest} obj Optional instance to populate.
   * @return {module:model/ActivateMultipleSIMsbyICCIDrequest} The populated <code>ActivateMultipleSIMsbyICCIDrequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('sims'))
        obj.sims = ApiClient.convertToType(data['sims'], ['String']);
  ...
  /**
   * Array of SIM numbers to activate
   * @member {Array.<String>} sims
   */
