...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.DeviceTag = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DeviceTag model module.
   * @module model/DeviceTag
   * @version 1.0
   */

  /**
   * Constructs a new <code>DeviceTag</code>.
   * @alias module:model/DeviceTag
   * @class
   */
  ...
  /**
   * Constructs a <code>DeviceTag</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeviceTag} obj Optional instance to populate.
   * @return {module:model/DeviceTag} The populated <code>DeviceTag</code> instance.
   */
  ...
  /**
   * Device IDs of devices associated with this tag
