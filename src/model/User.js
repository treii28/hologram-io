...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.User = factory(root.Hologram.ApiClient);
  }
   ...
   * @class
   * @param email {String} User's email address  This is the address that is used for logging into the Hologram Dashboard.
   */
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('personal_org'))
        obj.personalOrg = ApiClient.convertToType(data['personal_org'], 'Number');
  ...
  /**
   * Unique identifier for the user or user ID
   * @member {Number} id
   */
  exports.prototype.id = undefined;

  /**
   * User's email address  This is the address that is used for logging into the Hologram Dashboard.
   * @member {String} email
   */
  ...
  /**
   * Org ID of the user's personal organization
   * @member {Number} personalOrg
   */
  exports.prototype.personalOrg = undefined;

  /**
   * @member {String} billingmethod
   */
  exports.prototype.billingmethod = undefined;
