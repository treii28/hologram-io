...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.SendCloudMessagetoDeviceresponse = factory(root.Hologram.ApiClient, root.Hologram.Data8);
  }
}(this, function(ApiClient, Data8) {
  'use strict';

  /**
   * The SendCloudMessagetoDeviceresponse model module.
   * @module model/SendCloudMessagetoDeviceresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>SendCloudMessagetoDeviceresponse</code>.
   * @alias module:model/SendCloudMessagetoDeviceresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>SendCloudMessagetoDeviceresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendCloudMessagetoDeviceresponse} obj Optional instance to populate.
   * @return {module:model/SendCloudMessagetoDeviceresponse} The populated <code>SendCloudMessagetoDeviceresponse</code> instance.
   */
