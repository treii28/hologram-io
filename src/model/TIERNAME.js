...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Zones'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Zones'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.TIERNAME = factory(root.Hologram.ApiClient, root.Hologram.Zones);
  }
}(this, function(ApiClient, Zones) {
  'use strict';

  /**
   * The TIERNAME model module.
   * @module model/TIERNAME
   * @version 1.0
   */

  /**
   * Constructs a new <code>TIERNAME</code>.
   * Usually named after the number of devices necessary to enable the scaled pricing level.
   * @alias module:model/TIERNAME
   * @class
   */
  ...
  /**
   * Constructs a <code>TIERNAME</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TIERNAME} obj Optional instance to populate.
   * @return {module:model/TIERNAME} The populated <code>TIERNAME</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('zones'))
        obj.zones = Zones.constructFromObject(data['zones']);
    }
    return obj;
  }

  /**
   * This is the number of devices needed to be on your account  in order to hit the given tier's pricing
   * @member {Number} devicecount
   */
  exports.prototype.devicecount = undefined;

  /**
   * @member {module:model/Zones} zones
   */
