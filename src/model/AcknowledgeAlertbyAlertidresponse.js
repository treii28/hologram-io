...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.AcknowledgeAlertbyAlertidresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AcknowledgeAlertbyAlertidresponse model module.
   * @module model/AcknowledgeAlertbyAlertidresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>AcknowledgeAlertbyAlertidresponse</code>.
   * @alias module:model/AcknowledgeAlertbyAlertidresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AcknowledgeAlertbyAlertidresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AcknowledgeAlertbyAlertidresponse} obj Optional instance to populate.
   * @return {module:model/AcknowledgeAlertbyAlertidresponse} The populated <code>AcknowledgeAlertbyAlertidresponse</code> instance.
   */
