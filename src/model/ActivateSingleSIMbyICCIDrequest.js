...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ActivateSingleSIMbyICCIDrequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ActivateSingleSIMbyICCIDrequest model module.
   * @module model/ActivateSingleSIMbyICCIDrequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>ActivateSingleSIMbyICCIDrequest</code>.
   * @alias module:model/ActivateSingleSIMbyICCIDrequest
   * @class
   */
  ...
  /**
   * Constructs a <code>ActivateSingleSIMbyICCIDrequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActivateSingleSIMbyICCIDrequest} obj Optional instance to populate.
   * @return {module:model/ActivateSingleSIMbyICCIDrequest} The populated <code>ActivateSingleSIMbyICCIDrequest</code> instance.
   */
