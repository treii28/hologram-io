...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.RetrieveanOrganizationresponse = factory(root.Hologram.ApiClient, root.Hologram.Organization);
  }
}(this, function(ApiClient, Organization) {
  'use strict';

  /**
   * The RetrieveanOrganizationresponse model module.
   * @module model/RetrieveanOrganizationresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>RetrieveanOrganizationresponse</code>.
   * @alias module:model/RetrieveanOrganizationresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RetrieveanOrganizationresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RetrieveanOrganizationresponse} obj Optional instance to populate.
   * @return {module:model/RetrieveanOrganizationresponse} The populated <code>RetrieveanOrganizationresponse</code> instance.
   */
