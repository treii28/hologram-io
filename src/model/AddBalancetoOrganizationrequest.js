...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.AddBalancetoOrganizationrequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddBalancetoOrganizationrequest model module.
   * @module model/AddBalancetoOrganizationrequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>AddBalancetoOrganizationrequest</code>.
   * @alias module:model/AddBalancetoOrganizationrequest
   * @class
   */
  ...
  /**
   * Constructs a <code>AddBalancetoOrganizationrequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddBalancetoOrganizationrequest} obj Optional instance to populate.
   * @return {module:model/AddBalancetoOrganizationrequest} The populated <code>AddBalancetoOrganizationrequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('addamount'))
        obj.addamount = ApiClient.convertToType(data['addamount'], 'Number');
    }
    return obj;
  }

  /**
   * Amount to add to organization's balance
   * @member {Number} addamount
   */
  exports.prototype.addamount = undefined;
