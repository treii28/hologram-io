...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Lastsession', 'model/Links', 'model/Tags'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Lastsession'), require('./Links'), require('./Tags'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.Device = factory(root.Hologram.ApiClient, root.Hologram.Lastsession, root.Hologram.Links, root.Hologram.Tags);
  }
}(this, function(ApiClient, Lastsession, Links, Tags) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('phonenumber_cost'))
        obj.phonenumberCost = ApiClient.convertToType(data['phonenumber_cost'], 'String');
      ...
      if (data.hasOwnProperty('lastsession'))
        obj.lastsession = Lastsession.constructFromObject(data['lastsession']);
  ...
  /**
   * Unique device identifier or device ID
   * @member {Number} id
   */
  ...
  /**
   * Phone number associated with device. You can purchase a phone number on the Dashboard.
   ...
   * @member {String} phonenumberCost
   */
  exports.prototype.phonenumberCost = undefined;

  /**
   * Indicates if tunneling is enabled for the device  See the [guide](https://hologram.io/docs/guide/cloud/spacebridge-tunnel) for details
   * @member {Number} tunnelable
   */
  exports.prototype.tunnelable = undefined;

  /**
   * sv: 9575200740240801 (string) - Last IMEI-SV seen for this device. This is the same as IMEI but instead of check digit has two digits at end for software version.
   * @member {String} imei
   */
  exports.prototype.imei = undefined;

  /**
   * For internal Hologram use
   * @member {Number} hidden
   */
  exports.prototype.hidden = undefined;

  /**
   * User-configurable categories that you can use to classify your devices
  ...
  /**
   * @member {module:model/Lastsession} lastsession
   */
  exports.prototype.lastsession = undefined;

  /**
   * Model of modem based on IMEI value
   * @member {String} model
   */
  exports.prototype.model = undefined;

  /**
   * Manufacturer of modem based on IMEI value
