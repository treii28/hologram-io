...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccountBalance'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./AccountBalance'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.RetrieveOrganizationBalanceresponse = factory(root.Hologram.ApiClient, root.Hologram.AccountBalance);
  }
}(this, function(ApiClient, AccountBalance) {
  'use strict';

  /**
   * The RetrieveOrganizationBalanceresponse model module.
   * @module model/RetrieveOrganizationBalanceresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>RetrieveOrganizationBalanceresponse</code>.
   * @alias module:model/RetrieveOrganizationBalanceresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RetrieveOrganizationBalanceresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RetrieveOrganizationBalanceresponse} obj Optional instance to populate.
   * @return {module:model/RetrieveOrganizationBalanceresponse} The populated <code>RetrieveOrganizationBalanceresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = AccountBalance.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/AccountBalance} data
   */
