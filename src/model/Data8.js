...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.Data8 = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The Data8 model module.
   * @module model/Data8
   * @version 1.0
   */

  /**
   * Constructs a new <code>Data8</code>.
   * @alias module:model/Data8
   * @class
   */
  ...
  /**
   * Constructs a <code>Data8</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Data8} obj Optional instance to populate.
   * @return {module:model/Data8} The populated <code>Data8</code> instance.
   */
  ...
  /**
   * a167-4d9d-972e-b2ad0740d449 (string)
