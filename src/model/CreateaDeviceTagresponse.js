...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.CreateaDeviceTagresponse = factory(root.Hologram.ApiClient, root.Hologram.DeviceTag);
  }
}(this, function(ApiClient, DeviceTag) {
  'use strict';

  /**
   * The CreateaDeviceTagresponse model module.
   * @module model/CreateaDeviceTagresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>CreateaDeviceTagresponse</code>.
   * @alias module:model/CreateaDeviceTagresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateaDeviceTagresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateaDeviceTagresponse} obj Optional instance to populate.
   * @return {module:model/CreateaDeviceTagresponse} The populated <code>CreateaDeviceTagresponse</code> instance.
   */
