...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ListAllTACchangealertsresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ListAllTACchangealertsresponse model module.
   * @module model/ListAllTACchangealertsresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListAllTACchangealertsresponse</code>.
   * @alias module:model/ListAllTACchangealertsresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAllTACchangealertsresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAllTACchangealertsresponse} obj Optional instance to populate.
   * @return {module:model/ListAllTACchangealertsresponse} The populated <code>ListAllTACchangealertsresponse</code> instance.
   */
