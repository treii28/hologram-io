...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Data12'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Data12'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.ListOrganizationsBalanceHistoryresponse = factory(root.Hologram.ApiClient, root.Hologram.Data12);
  }
}(this, function(ApiClient, Data12) {
  'use strict';

  /**
   * The ListOrganizationsBalanceHistoryresponse model module.
   * @module model/ListOrganizationsBalanceHistoryresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListOrganizationsBalanceHistoryresponse</code>.
   * @alias module:model/ListOrganizationsBalanceHistoryresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListOrganizationsBalanceHistoryresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListOrganizationsBalanceHistoryresponse} obj Optional instance to populate.
   * @return {module:model/ListOrganizationsBalanceHistoryresponse} The populated <code>ListOrganizationsBalanceHistoryresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('continues'))
        obj.continues = ApiClient.convertToType(data['continues'], 'Boolean');
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [Data12]);
    }
    return obj;
  }
  ...
  /**
   * Only shows when limit is less than size
   * @member {Boolean} continues
   */
  exports.prototype.continues = undefined;

  /**
   * @member {Array.<module:model/Data12>} data
   */
