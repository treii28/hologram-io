...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.PauseorUnpauseDatarequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The PauseorUnpauseDatarequest model module.
   * @module model/PauseorUnpauseDatarequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>PauseorUnpauseDatarequest</code>.
   * @alias module:model/PauseorUnpauseDatarequest
   * @class
   */
  ...
  /**
   * Constructs a <code>PauseorUnpauseDatarequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/PauseorUnpauseDatarequest} obj Optional instance to populate.
   * @return {module:model/PauseorUnpauseDatarequest} The populated <code>PauseorUnpauseDatarequest</code> instance.
   */
  ...
  /**
   * New SIM state to set. Either `pause` or `live`.
   * @member {String} state
   */
