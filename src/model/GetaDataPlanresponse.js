...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.GetaDataPlanresponse = factory(root.Hologram.ApiClient, root.Hologram.DataPlan);
  }
}(this, function(ApiClient, DataPlan) {
  'use strict';

  /**
   * The GetaDataPlanresponse model module.
   * @module model/GetaDataPlanresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>GetaDataPlanresponse</code>.
   * @alias module:model/GetaDataPlanresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>GetaDataPlanresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/GetaDataPlanresponse} obj Optional instance to populate.
   * @return {module:model/GetaDataPlanresponse} The populated <code>GetaDataPlanresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = DataPlan.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/DataPlan} data
   */
