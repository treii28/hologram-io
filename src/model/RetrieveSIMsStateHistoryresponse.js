...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SimStateHistory'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SimStateHistory'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.RetrieveSIMsStateHistoryresponse = factory(root.Hologram.ApiClient, root.Hologram.SimStateHistory);
  }
}(this, function(ApiClient, SimStateHistory) {
  'use strict';

  /**
   * The RetrieveSIMsStateHistoryresponse model module.
   * @module model/RetrieveSIMsStateHistoryresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>RetrieveSIMsStateHistoryresponse</code>.
   * @alias module:model/RetrieveSIMsStateHistoryresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RetrieveSIMsStateHistoryresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RetrieveSIMsStateHistoryresponse} obj Optional instance to populate.
   * @return {module:model/RetrieveSIMsStateHistoryresponse} The populated <code>RetrieveSIMsStateHistoryresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [SimStateHistory]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/SimStateHistory>} data
   */
