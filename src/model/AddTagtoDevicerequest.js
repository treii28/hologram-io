...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.AddTagtoDevicerequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AddTagtoDevicerequest model module.
   * @module model/AddTagtoDevicerequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>AddTagtoDevicerequest</code>.
   * @alias module:model/AddTagtoDevicerequest
   * @class
   */
  ...
  /**
   * Constructs a <code>AddTagtoDevicerequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddTagtoDevicerequest} obj Optional instance to populate.
   * @return {module:model/AddTagtoDevicerequest} The populated <code>AddTagtoDevicerequest</code> instance.
   */
  ...
  /**
   * List of device IDs to link to this tag. All devices should be on the same organization as the tagid.
