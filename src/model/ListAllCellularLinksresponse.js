...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ListAllCellularLinksresponse = factory(root.Hologram.ApiClient, root.Hologram.CellularLink);
  }
}(this, function(ApiClient, CellularLink) {
  'use strict';

  /**
   * The ListAllCellularLinksresponse model module.
   * @module model/ListAllCellularLinksresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListAllCellularLinksresponse</code>.
   * @alias module:model/ListAllCellularLinksresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAllCellularLinksresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAllCellularLinksresponse} obj Optional instance to populate.
   * @return {module:model/ListAllCellularLinksresponse} The populated <code>ListAllCellularLinksresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [CellularLink]);
    }
    return obj;
  }
  ...
  /**
   * Only shows when there are more values
  ...
  /**
   * @member {Array.<module:model/CellularLink>} data
   */
