...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.CreateaPublicKeyrequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CreateaPublicKeyrequest model module.
   * @module model/CreateaPublicKeyrequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>CreateaPublicKeyrequest</code>.
   * @alias module:model/CreateaPublicKeyrequest
   * @class
  ...
  /**
   * Constructs a <code>CreateaPublicKeyrequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateaPublicKeyrequest} obj Optional instance to populate.
   * @return {module:model/CreateaPublicKeyrequest} The populated <code>CreateaPublicKeyrequest</code> instance.
   */
