...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ZONENAME'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ZONENAME'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.Zones = factory(root.Hologram.ApiClient, root.Hologram.ZONENAME);
  }
}(this, function(ApiClient, ZONENAME) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('ZONENAME'))
        obj.ZONENAME = ZONENAME.constructFromObject(data['ZONENAME']);
    }
    return obj;
  }

  /**
   * @member {module:model/ZONENAME} ZONENAME
   */
