...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.EnableaPublicKeyresponse = factory(root.Hologram.ApiClient, root.Hologram.Data10);
  }
}(this, function(ApiClient, Data10) {
  'use strict';

  /**
   * The EnableaPublicKeyresponse model module.
   * @module model/EnableaPublicKeyresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>EnableaPublicKeyresponse</code>.
   * @alias module:model/EnableaPublicKeyresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>EnableaPublicKeyresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/EnableaPublicKeyresponse} obj Optional instance to populate.
   * @return {module:model/EnableaPublicKeyresponse} The populated <code>EnableaPublicKeyresponse</code> instance.
   */
