...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.RetrieveaUserresponse = factory(root.Hologram.ApiClient, root.Hologram.User);
  }
}(this, function(ApiClient, User) {
  'use strict';

  /**
   * The RetrieveaUserresponse model module.
   * @module model/RetrieveaUserresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>RetrieveaUserresponse</code>.
   * @alias module:model/RetrieveaUserresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RetrieveaUserresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RetrieveaUserresponse} obj Optional instance to populate.
   * @return {module:model/RetrieveaUserresponse} The populated <code>RetrieveaUserresponse</code> instance.
   */
