...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ListAllDevicesresponse = factory(root.Hologram.ApiClient, root.Hologram.Device);
  }
}(this, function(ApiClient, Device) {
  'use strict';

  /**
   * The ListAllDevicesresponse model module.
   * @module model/ListAllDevicesresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListAllDevicesresponse</code>.
   * @alias module:model/ListAllDevicesresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAllDevicesresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAllDevicesresponse} obj Optional instance to populate.
   * @return {module:model/ListAllDevicesresponse} The populated <code>ListAllDevicesresponse</code> instance.
   */
