...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.AddBalancetoOrganizationresponse = factory(root.Hologram.ApiClient, root.Hologram.OrderData);
  }
}(this, function(ApiClient, OrderData) {
  'use strict';

  /**
   * The AddBalancetoOrganizationresponse model module.
   * @module model/AddBalancetoOrganizationresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>AddBalancetoOrganizationresponse</code>.
   * @alias module:model/AddBalancetoOrganizationresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AddBalancetoOrganizationresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddBalancetoOrganizationresponse} obj Optional instance to populate.
   * @return {module:model/AddBalancetoOrganizationresponse} The populated <code>AddBalancetoOrganizationresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('order_data'))
        obj.orderData = OrderData.constructFromObject(data['order_data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/OrderData} orderData
   */
