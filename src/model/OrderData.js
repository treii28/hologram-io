...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.OrderData = factory(root.Hologram.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('total_cost'))
        obj.totalCost = ApiClient.convertToType(data['total_cost'], 'Number');
      if (data.hasOwnProperty('description'))
        obj.description = ApiClient.convertToType(data['description'], 'String');
      if (data.hasOwnProperty('extra_description'))
        obj.extraDescription = ApiClient.convertToType(data['extra_description'], 'String');
      if (data.hasOwnProperty('needs_shipping'))
        obj.needsShipping = ApiClient.convertToType(data['needs_shipping'], 'Boolean');
  ...
  /**
   * Preview = true, actual transaction = false
  ...
  /**
   * Indicates if the order needs to be shipped
   * @member {Boolean} needsShipping
   */
  exports.prototype.needsShipping = undefined;
