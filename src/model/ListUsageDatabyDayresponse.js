...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Data5'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Data5'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.ListUsageDatabyDayresponse = factory(root.Hologram.ApiClient, root.Hologram.Data5);
  }
}(this, function(ApiClient, Data5) {
  'use strict';

  /**
   * The ListUsageDatabyDayresponse model module.
   * @module model/ListUsageDatabyDayresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListUsageDatabyDayresponse</code>.
   * @alias module:model/ListUsageDatabyDayresponse
   * @class
  ...
  /**
   * Constructs a <code>ListUsageDatabyDayresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListUsageDatabyDayresponse} obj Optional instance to populate.
   * @return {module:model/ListUsageDatabyDayresponse} The populated <code>ListUsageDatabyDayresponse</code> instance.
   */
