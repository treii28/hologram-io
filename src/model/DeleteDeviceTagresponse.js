...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.DeleteDeviceTagresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The DeleteDeviceTagresponse model module.
   * @module model/DeleteDeviceTagresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>DeleteDeviceTagresponse</code>.
   * @alias module:model/DeleteDeviceTagresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DeleteDeviceTagresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DeleteDeviceTagresponse} obj Optional instance to populate.
   * @return {module:model/DeleteDeviceTagresponse} The populated <code>DeleteDeviceTagresponse</code> instance.
   */
