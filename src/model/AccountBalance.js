...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.AccountBalance = factory(root.Hologram.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('promobalance'))
        obj.promobalance = ApiClient.convertToType(data['promobalance'], 'String');
      if (data.hasOwnProperty('minbalance'))
        obj.minbalance = ApiClient.convertToType(data['minbalance'], 'String');
      if (data.hasOwnProperty('topoffamount'))
        obj.topoffamount = ApiClient.convertToType(data['topoffamount'], 'String');
      if (data.hasOwnProperty('pendingcharges'))
        obj.pendingcharges = ApiClient.convertToType(data['pendingcharges'], 'String');
    }
    return obj;
  }
   ...
   * @member {String} promobalance
   */
  exports.prototype.promobalance = undefined;

  /**
   * Auto reload minimum balance as configured in the dashboard
   * @member {String} minbalance
   */
  exports.prototype.minbalance = undefined;

  /**
   * Auto reload amount as configured in the dashboard
   * @member {String} topoffamount
   */
  exports.prototype.topoffamount = undefined;

  /**
   * @member {String} pendingcharges
   */
  exports.prototype.pendingcharges = undefined;
