...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ListAllDeviceDataLimitalertsresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ListAllDeviceDataLimitalertsresponse model module.
   * @module model/ListAllDeviceDataLimitalertsresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListAllDeviceDataLimitalertsresponse</code>.
   * @alias module:model/ListAllDeviceDataLimitalertsresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAllDeviceDataLimitalertsresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAllDeviceDataLimitalertsresponse} obj Optional instance to populate.
   * @return {module:model/ListAllDeviceDataLimitalertsresponse} The populated <code>ListAllDeviceDataLimitalertsresponse</code> instance.
   */
  ...
  /**
   * Id for the last alert retrieved
