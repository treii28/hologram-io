...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.SendCloudMessagetoDeviceviaWebhookrequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SendCloudMessagetoDeviceviaWebhookrequest model module.
   * @module model/SendCloudMessagetoDeviceviaWebhookrequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>SendCloudMessagetoDeviceviaWebhookrequest</code>.
   * @alias module:model/SendCloudMessagetoDeviceviaWebhookrequest
   * @class
   */
  ...
  /**
   * Constructs a <code>SendCloudMessagetoDeviceviaWebhookrequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendCloudMessagetoDeviceviaWebhookrequest} obj Optional instance to populate.
   * @return {module:model/SendCloudMessagetoDeviceviaWebhookrequest} The populated <code>SendCloudMessagetoDeviceviaWebhookrequest</code> instance.
   */
  ...
  /**
   * Data to send, encoded in base64. Max length of 10k bytes. Must send either data or base64data
