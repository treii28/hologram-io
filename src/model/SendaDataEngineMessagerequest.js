...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.SendaDataEngineMessagerequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SendaDataEngineMessagerequest model module.
   * @module model/SendaDataEngineMessagerequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>SendaDataEngineMessagerequest</code>.
   * @alias module:model/SendaDataEngineMessagerequest
   * @class
   */
  ...
  /**
   * Constructs a <code>SendaDataEngineMessagerequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendaDataEngineMessagerequest} obj Optional instance to populate.
   * @return {module:model/SendaDataEngineMessagerequest} The populated <code>SendaDataEngineMessagerequest</code> instance.
   */
  ...
  /**
   * Device ID to associate the message to
   * @member {Number} deviceid
   */
  exports.prototype.deviceid = undefined;

  /**
   * Additional topics to associate with the message. Optional
