...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ActivateSingleSIMbyICCIDresponse = factory(root.Hologram.ApiClient, root.Hologram.Data);
  }
}(this, function(ApiClient, Data) {
  'use strict';

  /**
   * The ActivateSingleSIMbyICCIDresponse model module.
   * @module model/ActivateSingleSIMbyICCIDresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ActivateSingleSIMbyICCIDresponse</code>.
   * @alias module:model/ActivateSingleSIMbyICCIDresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ActivateSingleSIMbyICCIDresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActivateSingleSIMbyICCIDresponse} obj Optional instance to populate.
   * @return {module:model/ActivateSingleSIMbyICCIDresponse} The populated <code>ActivateSingleSIMbyICCIDresponse</code> instance.
   */
