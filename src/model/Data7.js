...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.Data7 = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The Data7 model module.
   * @module model/Data7
   * @version 1.0
   */

  /**
   * Constructs a new <code>Data7</code>.
   * @alias module:model/Data7
   * @class
   * @param linkid {Number} 
   * @param curPeriodEnd {String} 
   * @param periodsBack {String} 
   * @param recordId {String} 
   * @param bytes {Number} 
   */
  var exports = function(linkid, curPeriodEnd, periodsBack, recordId, bytes) {
    this.linkid = linkid;
    this.curPeriodEnd = curPeriodEnd;
  ...
  /**
   * Constructs a <code>Data7</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Data7} obj Optional instance to populate.
   * @return {module:model/Data7} The populated <code>Data7</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('cur_period_end'))
        obj.curPeriodEnd = ApiClient.convertToType(data['cur_period_end'], 'String');
      if (data.hasOwnProperty('periods_back'))
        obj.periodsBack = ApiClient.convertToType(data['periods_back'], 'String');
      if (data.hasOwnProperty('record_id'))
        obj.recordId = ApiClient.convertToType(data['record_id'], 'String');
  ...
  /**
   * @member {String} curPeriodEnd
   */
  exports.prototype.curPeriodEnd = undefined;

  /**
   * @member {String} periodsBack
   */
  exports.prototype.periodsBack = undefined;
