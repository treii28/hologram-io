...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.SendSMStoDevicerequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SendSMStoDevicerequest model module.
   * @module model/SendSMStoDevicerequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>SendSMStoDevicerequest</code>.
   * @alias module:model/SendSMStoDevicerequest
   * @class
   * @param deviceid {Number} Device ID of recipient device
   * @param deviceids {Array.<String>} Device IDs of the recipient devices. Either an array of IDs or an ID is required, not both.
   */
  var exports = function(deviceid, deviceids) {
    this.deviceid = deviceid;
    this.deviceids = deviceids;
  };

  /**
   * Constructs a <code>SendSMStoDevicerequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendSMStoDevicerequest} obj Optional instance to populate.
   * @return {module:model/SendSMStoDevicerequest} The populated <code>SendSMStoDevicerequest</code> instance.
   */
  ...
  /**
   * Device ID of recipient device
   * @member {Number} deviceid
   */
  exports.prototype.deviceid = undefined;

  /**
   * Device IDs of the recipient devices. Either an array of IDs or an ID is required, not both.
   * @member {Array.<String>} deviceids
   */
  exports.prototype.deviceids = undefined;

  /**
   * Phone number to display as the sender. Optional.
   * @member {String} fromnumber
   */
  exports.prototype.fromnumber = undefined;

  /**
   * ASCII Text message body
   * @member {String} body
   */
