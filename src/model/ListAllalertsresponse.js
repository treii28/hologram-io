...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ListAllalertsresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ListAllalertsresponse model module.
   * @module model/ListAllalertsresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListAllalertsresponse</code>.
   * @alias module:model/ListAllalertsresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAllalertsresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAllalertsresponse} obj Optional instance to populate.
   * @return {module:model/ListAllalertsresponse} The populated <code>ListAllalertsresponse</code> instance.
   */
