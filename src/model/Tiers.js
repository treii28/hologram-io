...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TIERNAME'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TIERNAME'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.Tiers = factory(root.Hologram.ApiClient, root.Hologram.TIERNAME);
  }
}(this, function(ApiClient, TIERNAME) {
  'use strict';
   ...
   * Tiers represent automatic scaling plan discounts based on the number of SIMs you have on the plan
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('TIERNAME'))
        obj.TIERNAME = TIERNAME.constructFromObject(data['TIERNAME']);
    }
    return obj;
  }

  /**
   * @member {module:model/TIERNAME} TIERNAME
   */
  exports.prototype.TIERNAME = undefined;
