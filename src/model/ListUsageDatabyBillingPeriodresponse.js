...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Data7'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Data7'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.ListUsageDatabyBillingPeriodresponse = factory(root.Hologram.ApiClient, root.Hologram.Data7);
  }
}(this, function(ApiClient, Data7) {
  'use strict';

  /**
   * The ListUsageDatabyBillingPeriodresponse model module.
   * @module model/ListUsageDatabyBillingPeriodresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListUsageDatabyBillingPeriodresponse</code>.
   * @alias module:model/ListUsageDatabyBillingPeriodresponse
   * @class
   * @param success {Boolean} 
   * @param data {Array.<module:model/Data7>} 
   */
  var exports = function(success, data) {
    this.success = success;
    this.data = data;
  };

  /**
   * Constructs a <code>ListUsageDatabyBillingPeriodresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListUsageDatabyBillingPeriodresponse} obj Optional instance to populate.
   * @return {module:model/ListUsageDatabyBillingPeriodresponse} The populated <code>ListUsageDatabyBillingPeriodresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [Data7]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Data7>} data
   */
