...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.SimStateHistory = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SimStateHistory model module.
   * @module model/SimStateHistory
   * @version 1.0
   */

  /**
   * Constructs a new <code>SimStateHistory</code>.
   * @alias module:model/SimStateHistory
   * @class
   */
  ...
  /**
   * Constructs a <code>SimStateHistory</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SimStateHistory} obj Optional instance to populate.
   * @return {module:model/SimStateHistory} The populated <code>SimStateHistory</code> instance.
   */
   ...
   */
  exports.prototype.oldstate = undefined;

  /**
   * PENDING (string) - New SIM state
   * @member {String} newstate
   */
  exports.prototype.newstate = undefined;
