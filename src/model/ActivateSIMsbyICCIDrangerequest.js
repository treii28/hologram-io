...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ActivateSIMsbyICCIDrangerequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ActivateSIMsbyICCIDrangerequest model module.
   * @module model/ActivateSIMsbyICCIDrangerequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>ActivateSIMsbyICCIDrangerequest</code>.
   * @alias module:model/ActivateSIMsbyICCIDrangerequest
   * @class
   */
  ...
  /**
   * Constructs a <code>ActivateSIMsbyICCIDrangerequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActivateSIMsbyICCIDrangerequest} obj Optional instance to populate.
   * @return {module:model/ActivateSIMsbyICCIDrangerequest} The populated <code>ActivateSIMsbyICCIDrangerequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('simrange'))
        obj.simrange = ApiClient.convertToType(data['simrange'], 'String');
  ...
  /**
   * Range of SIM numbers to activate
   * @member {String} simrange
   */
  exports.prototype.simrange = undefined;

  /**
   * Device data plan. Look up plan IDs with  [List Data Plans](#reference/device-management/data-plans/list-data-plans).
   * @member {Number} plan
   */
