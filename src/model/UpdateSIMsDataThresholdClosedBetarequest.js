...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.UpdateSIMsDataThresholdClosedBetarequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UpdateSIMsDataThresholdClosedBetarequest model module.
   * @module model/UpdateSIMsDataThresholdClosedBetarequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>UpdateSIMsDataThresholdClosedBetarequest</code>.
   * @alias module:model/UpdateSIMsDataThresholdClosedBetarequest
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateSIMsDataThresholdClosedBetarequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateSIMsDataThresholdClosedBetarequest} obj Optional instance to populate.
   * @return {module:model/UpdateSIMsDataThresholdClosedBetarequest} The populated <code>UpdateSIMsDataThresholdClosedBetarequest</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      obj = obj || new exports();
      if (data.hasOwnProperty('datathreshold'))
        obj.datathreshold = ApiClient.convertToType(data['datathreshold'], 'Number');
    }
    return obj;
  }

  /**
   * New data threshold in bytes
   * @member {Number} datathreshold
   */
  exports.prototype.datathreshold = undefined;
