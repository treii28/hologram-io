...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.Data10 = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The Data10 model module.
   * @module model/Data10
   * @version 1.0
   */

  /**
   * Constructs a new <code>Data10</code>.
   * @alias module:model/Data10
   * @class
   */
  ...
  /**
   * Constructs a <code>Data10</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Data10} obj Optional instance to populate.
   * @return {module:model/Data10} The populated <code>Data10</code> instance.
   */
