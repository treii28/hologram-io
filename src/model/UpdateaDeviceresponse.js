...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.UpdateaDeviceresponse = factory(root.Hologram.ApiClient, root.Hologram.Device);
  }
}(this, function(ApiClient, Device) {
  'use strict';

  /**
   * The UpdateaDeviceresponse model module.
   * @module model/UpdateaDeviceresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>UpdateaDeviceresponse</code>.
   * @alias module:model/UpdateaDeviceresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateaDeviceresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateaDeviceresponse} obj Optional instance to populate.
   * @return {module:model/UpdateaDeviceresponse} The populated <code>UpdateaDeviceresponse</code> instance.
   */
