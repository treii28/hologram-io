...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Data8'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Data8'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.SendCloudMessagetoDeviceviaWebhookresponse = factory(root.Hologram.ApiClient, root.Hologram.Data8);
  }
}(this, function(ApiClient, Data8) {
  'use strict';

  /**
   * The SendCloudMessagetoDeviceviaWebhookresponse model module.
   * @module model/SendCloudMessagetoDeviceviaWebhookresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>SendCloudMessagetoDeviceviaWebhookresponse</code>.
   * @alias module:model/SendCloudMessagetoDeviceviaWebhookresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>SendCloudMessagetoDeviceviaWebhookresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendCloudMessagetoDeviceviaWebhookresponse} obj Optional instance to populate.
   * @return {module:model/SendCloudMessagetoDeviceviaWebhookresponse} The populated <code>SendCloudMessagetoDeviceviaWebhookresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [Data8]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Data8>} data
   */
