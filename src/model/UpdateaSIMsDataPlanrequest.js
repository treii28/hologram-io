...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.UpdateaSIMsDataPlanrequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UpdateaSIMsDataPlanrequest model module.
   * @module model/UpdateaSIMsDataPlanrequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>UpdateaSIMsDataPlanrequest</code>.
   * @alias module:model/UpdateaSIMsDataPlanrequest
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateaSIMsDataPlanrequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateaSIMsDataPlanrequest} obj Optional instance to populate.
   * @return {module:model/UpdateaSIMsDataPlanrequest} The populated <code>UpdateaSIMsDataPlanrequest</code> instance.
   */
  ...
  /**
   * Org ID the device is currently owned by
   * @member {Number} orgid
   */
