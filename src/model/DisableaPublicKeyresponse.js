...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Data10'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Data10'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.DisableaPublicKeyresponse = factory(root.Hologram.ApiClient, root.Hologram.Data10);
  }
}(this, function(ApiClient, Data10) {
  'use strict';

  /**
   * The DisableaPublicKeyresponse model module.
   * @module model/DisableaPublicKeyresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>DisableaPublicKeyresponse</code>.
   * @alias module:model/DisableaPublicKeyresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>DisableaPublicKeyresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/DisableaPublicKeyresponse} obj Optional instance to populate.
   * @return {module:model/DisableaPublicKeyresponse} The populated <code>DisableaPublicKeyresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = Data10.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/Data10} data
   */
