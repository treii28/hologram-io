...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.UpdateaDevicerequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UpdateaDevicerequest model module.
   * @module model/UpdateaDevicerequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>UpdateaDevicerequest</code>.
   * @alias module:model/UpdateaDevicerequest
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateaDevicerequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateaDevicerequest} obj Optional instance to populate.
   * @return {module:model/UpdateaDevicerequest} The populated <code>UpdateaDevicerequest</code> instance.
   */
  ...
  /**
   * Update name of the device
   * @member {String} name
   */
  exports.prototype.name = undefined;

  /**
   * Move device between organizations. Your API key must be at least an  Admin on both organizations for this to succeed
   * @member {Number} orgid
   */
