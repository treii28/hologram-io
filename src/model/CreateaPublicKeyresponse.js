...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.CreateaPublicKeyresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CreateaPublicKeyresponse model module.
   * @module model/CreateaPublicKeyresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>CreateaPublicKeyresponse</code>.
   * @alias module:model/CreateaPublicKeyresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>CreateaPublicKeyresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateaPublicKeyresponse} obj Optional instance to populate.
   * @return {module:model/CreateaPublicKeyresponse} The populated <code>CreateaPublicKeyresponse</code> instance.
   */
