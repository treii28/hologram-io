...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DataPlan'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DataPlan'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.ListAllDataPlansresponse = factory(root.Hologram.ApiClient, root.Hologram.DataPlan);
  }
}(this, function(ApiClient, DataPlan) {
  'use strict';

  /**
   * The ListAllDataPlansresponse model module.
   * @module model/ListAllDataPlansresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListAllDataPlansresponse</code>.
   * @alias module:model/ListAllDataPlansresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAllDataPlansresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAllDataPlansresponse} obj Optional instance to populate.
   * @return {module:model/ListAllDataPlansresponse} The populated <code>ListAllDataPlansresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [DataPlan]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/DataPlan>} data
   */
