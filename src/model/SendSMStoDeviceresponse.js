...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.SendSMStoDeviceresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SendSMStoDeviceresponse model module.
   * @module model/SendSMStoDeviceresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>SendSMStoDeviceresponse</code>.
   * @alias module:model/SendSMStoDeviceresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>SendSMStoDeviceresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendSMStoDeviceresponse} obj Optional instance to populate.
   * @return {module:model/SendSMStoDeviceresponse} The populated <code>SendSMStoDeviceresponse</code> instance.
   */
