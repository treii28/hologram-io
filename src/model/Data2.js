...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.Data2 = factory(root.Hologram.ApiClient);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('link'))
        obj.link = ApiClient.convertToType(data['link'], 'Number');
  ...
  /**
   * Device ID: ID of the new corresponding device
   * @member {Number} device
   */
  exports.prototype.device = undefined;

  /**
   * Link ID: ID of the new cellular link
   * @member {Number} link
   */
