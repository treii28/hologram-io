...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ListDeviceTagsresponse = factory(root.Hologram.ApiClient, root.Hologram.DeviceTag);
  }
}(this, function(ApiClient, DeviceTag) {
  'use strict';

  /**
   * The ListDeviceTagsresponse model module.
   * @module model/ListDeviceTagsresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListDeviceTagsresponse</code>.
   * @alias module:model/ListDeviceTagsresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListDeviceTagsresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListDeviceTagsresponse} obj Optional instance to populate.
   * @return {module:model/ListDeviceTagsresponse} The populated <code>ListDeviceTagsresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [DeviceTag]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/DeviceTag>} data
   */
