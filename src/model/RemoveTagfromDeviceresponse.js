...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/DeviceTag'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./DeviceTag'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.RemoveTagfromDeviceresponse = factory(root.Hologram.ApiClient, root.Hologram.DeviceTag);
  }
}(this, function(ApiClient, DeviceTag) {
  'use strict';

  /**
   * The RemoveTagfromDeviceresponse model module.
   * @module model/RemoveTagfromDeviceresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>RemoveTagfromDeviceresponse</code>.
   * @alias module:model/RemoveTagfromDeviceresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RemoveTagfromDeviceresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RemoveTagfromDeviceresponse} obj Optional instance to populate.
   * @return {module:model/RemoveTagfromDeviceresponse} The populated <code>RemoveTagfromDeviceresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = DeviceTag.constructFromObject(data['data']);
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/DeviceTag} data
   */
