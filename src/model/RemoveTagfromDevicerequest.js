...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.RemoveTagfromDevicerequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The RemoveTagfromDevicerequest model module.
   * @module model/RemoveTagfromDevicerequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>RemoveTagfromDevicerequest</code>.
   * @alias module:model/RemoveTagfromDevicerequest
   * @class
   */
  ...
  /**
   * Constructs a <code>RemoveTagfromDevicerequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RemoveTagfromDevicerequest} obj Optional instance to populate.
   * @return {module:model/RemoveTagfromDevicerequest} The populated <code>RemoveTagfromDevicerequest</code> instance.
   */
  ...
  /**
   * List of device IDs to unlink from this tag
