...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ZONENAME = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ZONENAME model module.
   * @module model/ZONENAME
   * @version 1.0
   */

  /**
   * Constructs a new <code>ZONENAME</code>.
   * ZONENAME could be something like \"global\" or \"1\" or \"2\"
   * @alias module:model/ZONENAME
   * @class
   */
  ...
  /**
   * Constructs a <code>ZONENAME</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ZONENAME} obj Optional instance to populate.
   * @return {module:model/ZONENAME} The populated <code>ZONENAME</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('overage'))
        obj.overage = ApiClient.convertToType(data['overage'], 'String');
    }
    return obj;
  }
