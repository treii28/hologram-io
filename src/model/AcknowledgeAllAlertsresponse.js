...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.AcknowledgeAllAlertsresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AcknowledgeAllAlertsresponse model module.
   * @module model/AcknowledgeAllAlertsresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>AcknowledgeAllAlertsresponse</code>.
   * @alias module:model/AcknowledgeAllAlertsresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AcknowledgeAllAlertsresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AcknowledgeAllAlertsresponse} obj Optional instance to populate.
   * @return {module:model/AcknowledgeAllAlertsresponse} The populated <code>AcknowledgeAllAlertsresponse</code> instance.
   */
