...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.AddTagtoDeviceresponse = factory(root.Hologram.ApiClient, root.Hologram.DeviceTag);
  }
}(this, function(ApiClient, DeviceTag) {
  'use strict';

  /**
   * The AddTagtoDeviceresponse model module.
   * @module model/AddTagtoDeviceresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>AddTagtoDeviceresponse</code>.
   * @alias module:model/AddTagtoDeviceresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AddTagtoDeviceresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AddTagtoDeviceresponse} obj Optional instance to populate.
   * @return {module:model/AddTagtoDeviceresponse} The populated <code>AddTagtoDeviceresponse</code> instance.
   */
