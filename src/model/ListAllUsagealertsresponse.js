...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ListAllUsagealertsresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ListAllUsagealertsresponse model module.
   * @module model/ListAllUsagealertsresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListAllUsagealertsresponse</code>.
   * @alias module:model/ListAllUsagealertsresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAllUsagealertsresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAllUsagealertsresponse} obj Optional instance to populate.
   * @return {module:model/ListAllUsagealertsresponse} The populated <code>ListAllUsagealertsresponse</code> instance.
   */
