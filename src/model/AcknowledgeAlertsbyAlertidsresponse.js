...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.AcknowledgeAlertsbyAlertidsresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AcknowledgeAlertsbyAlertidsresponse model module.
   * @module model/AcknowledgeAlertsbyAlertidsresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>AcknowledgeAlertsbyAlertidsresponse</code>.
   * @alias module:model/AcknowledgeAlertsbyAlertidsresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>AcknowledgeAlertsbyAlertidsresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AcknowledgeAlertsbyAlertidsresponse} obj Optional instance to populate.
   * @return {module:model/AcknowledgeAlertsbyAlertidsresponse} The populated <code>AcknowledgeAlertsbyAlertidsresponse</code> instance.
   */
