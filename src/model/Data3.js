...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.Data3 = factory(root.Hologram.ApiClient);
  }
  ...
  /**
   * PENDING-USER (string) - New state of the link.  May be a 'pending' state until the change is propagated to the cellular network.
