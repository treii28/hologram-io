...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/TunnelKey'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./TunnelKey'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.ListAllPublicKeysresponse = factory(root.Hologram.ApiClient, root.Hologram.TunnelKey);
  }
}(this, function(ApiClient, TunnelKey) {
  'use strict';

  /**
   * The ListAllPublicKeysresponse model module.
   * @module model/ListAllPublicKeysresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListAllPublicKeysresponse</code>.
   * @alias module:model/ListAllPublicKeysresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAllPublicKeysresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAllPublicKeysresponse} obj Optional instance to populate.
   * @return {module:model/ListAllPublicKeysresponse} The populated <code>ListAllPublicKeysresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [TunnelKey]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/TunnelKey>} data
   */
