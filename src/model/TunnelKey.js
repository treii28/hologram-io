...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.TunnelKey = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The TunnelKey model module.
   * @module model/TunnelKey
   * @version 1.0
   */

  /**
   * Constructs a new <code>TunnelKey</code>.
   * @alias module:model/TunnelKey
   * @class
   */
  ...
  /**
   * Constructs a <code>TunnelKey</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/TunnelKey} obj Optional instance to populate.
   * @return {module:model/TunnelKey} The populated <code>TunnelKey</code> instance.
   */
  ...
  /**
   * User ID of the user that the key belongs to
   * @member {Number} userid
   */
  exports.prototype.userid = undefined;

  /**
   * If the key is enabled, this is 0. Non-zero if the key is disabled
