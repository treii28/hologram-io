...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.Zones1 = factory(root.Hologram.ApiClient, root.Hologram.Zone);
  }
}(this, function(ApiClient, Zone) {
  'use strict';

  /**
   * The Zones1 model module.
   * @module model/Zones1
   * @version 1.0
   */

  /**
   * Constructs a new <code>Zones1</code>.
   * Zone pricing for the current tier
   * @alias module:model/Zones1
   * @class
   */
  ...
  /**
   * Constructs a <code>Zones1</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Zones1} obj Optional instance to populate.
   * @return {module:model/Zones1} The populated <code>Zones1</code> instance.
   */
