...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.Data6 = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The Data6 model module.
   * @module model/Data6
   * @version 1.0
   */

  /**
   * Constructs a new <code>Data6</code>.
   * @alias module:model/Data6
   * @class
   * @param linkid {Number} 
   * @param recordId {String} 
   * @param month {Number} 
   * @param year {Number} 
   * @param sessionCount {String} 
   * @param bytes {Number} 
   */
  var exports = function(linkid, recordId, month, year, sessionCount, bytes) {
    this.linkid = linkid;
  ...
  /**
   * Constructs a <code>Data6</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/Data6} obj Optional instance to populate.
   * @return {module:model/Data6} The populated <code>Data6</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('session_count'))
        obj.sessionCount = ApiClient.convertToType(data['session_count'], 'String');
