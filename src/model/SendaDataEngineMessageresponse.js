...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.SendaDataEngineMessageresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The SendaDataEngineMessageresponse model module.
   * @module model/SendaDataEngineMessageresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>SendaDataEngineMessageresponse</code>.
   * @alias module:model/SendaDataEngineMessageresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>SendaDataEngineMessageresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/SendaDataEngineMessageresponse} obj Optional instance to populate.
   * @return {module:model/SendaDataEngineMessageresponse} The populated <code>SendaDataEngineMessageresponse</code> instance.
   */
