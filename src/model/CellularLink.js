...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.CellularLink = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CellularLink model module.
   * @module model/CellularLink
   * @version 1.0
   */

  /**
   * Constructs a new <code>CellularLink</code>.
   * @alias module:model/CellularLink
   * @class
   */
  ...
  /**
   * Constructs a <code>CellularLink</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CellularLink} obj Optional instance to populate.
   * @return {module:model/CellularLink} The populated <code>CellularLink</code> instance.
   */
  ...
  /**
   * SIM data limit in Bytes. If there is no limit, `overagelimit` is -1. See the  [guide](https://hologram.io/docs/guide/connect/device-management#data-and-overage-limits) for details on overage limits.
