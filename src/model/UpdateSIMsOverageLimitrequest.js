...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.UpdateSIMsOverageLimitrequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UpdateSIMsOverageLimitrequest model module.
   * @module model/UpdateSIMsOverageLimitrequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>UpdateSIMsOverageLimitrequest</code>.
   * @alias module:model/UpdateSIMsOverageLimitrequest
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateSIMsOverageLimitrequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateSIMsOverageLimitrequest} obj Optional instance to populate.
   * @return {module:model/UpdateSIMsOverageLimitrequest} The populated <code>UpdateSIMsOverageLimitrequest</code> instance.
   */
  ...
  /**
   * Number of bytes over the plan limit to allow. Set `-1` for no data limit. See the [guide](https://hologram.io/docs/guide/connect/device-management#data-and-overage-limits) for details.
   * @member {Number} limit
   */
