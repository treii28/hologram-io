...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.AcknowledgeAlertsbyAlertidsrequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The AcknowledgeAlertsbyAlertidsrequest model module.
   * @module model/AcknowledgeAlertsbyAlertidsrequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>AcknowledgeAlertsbyAlertidsrequest</code>.
   * @alias module:model/AcknowledgeAlertsbyAlertidsrequest
   * @class
   */
  ...
  /**
   * Constructs a <code>AcknowledgeAlertsbyAlertidsrequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AcknowledgeAlertsbyAlertidsrequest} obj Optional instance to populate.
   * @return {module:model/AcknowledgeAlertsbyAlertidsrequest} The populated <code>AcknowledgeAlertsbyAlertidsrequest</code> instance.
   */
   ...
   */
  exports.prototype.alertIds = undefined;
