...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.UpdateaSIMsDataPlanresponse = factory(root.Hologram.ApiClient, root.Hologram.OrderData);
  }
}(this, function(ApiClient, OrderData) {
  'use strict';

  /**
   * The UpdateaSIMsDataPlanresponse model module.
   * @module model/UpdateaSIMsDataPlanresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>UpdateaSIMsDataPlanresponse</code>.
   * @alias module:model/UpdateaSIMsDataPlanresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateaSIMsDataPlanresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateaSIMsDataPlanresponse} obj Optional instance to populate.
   * @return {module:model/UpdateaSIMsDataPlanresponse} The populated <code>UpdateaSIMsDataPlanresponse</code> instance.
   */
