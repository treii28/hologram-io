...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.RetrieveaDeviceresponse = factory(root.Hologram.ApiClient, root.Hologram.Device);
  }
}(this, function(ApiClient, Device) {
  'use strict';

  /**
   * The RetrieveaDeviceresponse model module.
   * @module model/RetrieveaDeviceresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>RetrieveaDeviceresponse</code>.
   * @alias module:model/RetrieveaDeviceresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>RetrieveaDeviceresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/RetrieveaDeviceresponse} obj Optional instance to populate.
   * @return {module:model/RetrieveaDeviceresponse} The populated <code>RetrieveaDeviceresponse</code> instance.
   */
