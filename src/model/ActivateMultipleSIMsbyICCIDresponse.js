...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ActivateMultipleSIMsbyICCIDresponse = factory(root.Hologram.ApiClient, root.Hologram.Data);
  }
}(this, function(ApiClient, Data) {
  'use strict';

  /**
   * The ActivateMultipleSIMsbyICCIDresponse model module.
   * @module model/ActivateMultipleSIMsbyICCIDresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ActivateMultipleSIMsbyICCIDresponse</code>.
   * @alias module:model/ActivateMultipleSIMsbyICCIDresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ActivateMultipleSIMsbyICCIDresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActivateMultipleSIMsbyICCIDresponse} obj Optional instance to populate.
   * @return {module:model/ActivateMultipleSIMsbyICCIDresponse} The populated <code>ActivateMultipleSIMsbyICCIDresponse</code> instance.
   */
