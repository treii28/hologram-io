...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Data2'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Data2'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.ActivateSIMsbyICCIDrangeresponse = factory(root.Hologram.ApiClient, root.Hologram.Data2);
  }
}(this, function(ApiClient, Data2) {
  'use strict';

  /**
   * The ActivateSIMsbyICCIDrangeresponse model module.
   * @module model/ActivateSIMsbyICCIDrangeresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ActivateSIMsbyICCIDrangeresponse</code>.
   * @alias module:model/ActivateSIMsbyICCIDrangeresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ActivateSIMsbyICCIDrangeresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ActivateSIMsbyICCIDrangeresponse} obj Optional instance to populate.
   * @return {module:model/ActivateSIMsbyICCIDrangeresponse} The populated <code>ActivateSIMsbyICCIDrangeresponse</code> instance.
   */
