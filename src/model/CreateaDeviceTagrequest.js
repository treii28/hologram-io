...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.CreateaDeviceTagrequest = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The CreateaDeviceTagrequest model module.
   * @module model/CreateaDeviceTagrequest
   * @version 1.0
   */

  /**
   * Constructs a new <code>CreateaDeviceTagrequest</code>.
   * @alias module:model/CreateaDeviceTagrequest
   * @class
   * @param name {String} Name for the new tag, try to use shorter
   */
  ...
  /**
   * Constructs a <code>CreateaDeviceTagrequest</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/CreateaDeviceTagrequest} obj Optional instance to populate.
   * @return {module:model/CreateaDeviceTagrequest} The populated <code>CreateaDeviceTagrequest</code> instance.
   */
  ...
  /**
   * Name for the new tag, try to use shorter
   * @member {String} name
   */
  exports.prototype.name = undefined;

  /**
   * Devices to add to the new tag (optional)
