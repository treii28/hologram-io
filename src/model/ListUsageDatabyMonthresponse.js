...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Data6'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Data6'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.ListUsageDatabyMonthresponse = factory(root.Hologram.ApiClient, root.Hologram.Data6);
  }
}(this, function(ApiClient, Data6) {
  'use strict';

  /**
   * The ListUsageDatabyMonthresponse model module.
   * @module model/ListUsageDatabyMonthresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListUsageDatabyMonthresponse</code>.
   * @alias module:model/ListUsageDatabyMonthresponse
   * @class
   * @param success {Boolean} 
   * @param data {Array.<module:model/Data6>} 
   */
  ...
  /**
   * Constructs a <code>ListUsageDatabyMonthresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListUsageDatabyMonthresponse} obj Optional instance to populate.
   * @return {module:model/ListUsageDatabyMonthresponse} The populated <code>ListUsageDatabyMonthresponse</code> instance.
   */
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('data'))
        obj.data = ApiClient.convertToType(data['data'], [Data6]);
    }
    return obj;
  }
  ...
  /**
   * @member {Array.<module:model/Data6>} data
   */
