...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.ListAllCustomalertsresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The ListAllCustomalertsresponse model module.
   * @module model/ListAllCustomalertsresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>ListAllCustomalertsresponse</code>.
   * @alias module:model/ListAllCustomalertsresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>ListAllCustomalertsresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/ListAllCustomalertsresponse} obj Optional instance to populate.
   * @return {module:model/ListAllCustomalertsresponse} The populated <code>ListAllCustomalertsresponse</code> instance.
   */
