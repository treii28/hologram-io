...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.UpdateSIMsOverageLimitresponse = factory(root.Hologram.ApiClient, root.Hologram.CellularLink);
  }
}(this, function(ApiClient, CellularLink) {
  'use strict';

  /**
   * The UpdateSIMsOverageLimitresponse model module.
   * @module model/UpdateSIMsOverageLimitresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>UpdateSIMsOverageLimitresponse</code>.
   * @alias module:model/UpdateSIMsOverageLimitresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>UpdateSIMsOverageLimitresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UpdateSIMsOverageLimitresponse} obj Optional instance to populate.
   * @return {module:model/UpdateSIMsOverageLimitresponse} The populated <code>UpdateSIMsOverageLimitresponse</code> instance.
   */
