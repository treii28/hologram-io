...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Hologram.UnacknowledgeAlertbyAlertidresponse = factory(root.Hologram.ApiClient);
  }
}(this, function(ApiClient) {
  'use strict';

  /**
   * The UnacknowledgeAlertbyAlertidresponse model module.
   * @module model/UnacknowledgeAlertbyAlertidresponse
   * @version 1.0
   */

  /**
   * Constructs a new <code>UnacknowledgeAlertbyAlertidresponse</code>.
   * @alias module:model/UnacknowledgeAlertbyAlertidresponse
   * @class
   */
  ...
  /**
   * Constructs a <code>UnacknowledgeAlertbyAlertidresponse</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/UnacknowledgeAlertbyAlertidresponse} obj Optional instance to populate.
   * @return {module:model/UnacknowledgeAlertbyAlertidresponse} The populated <code>UnacknowledgeAlertbyAlertidresponse</code> instance.
   */
