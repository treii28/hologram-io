...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SendSMStoDevicerequest', 'model/SendSMStoDeviceresponse'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/SendSMStoDevicerequest'), require('../model/SendSMStoDeviceresponse'));
  } else {
    // Browser globals (root is window)
    if (!root.Hologram) {
      root.Hologram = {};
    }
    root.Hologram.SMSApi = factory(root.Hologram.ApiClient, root.Hologram.SendSMStoDevicerequest, root.Hologram.SendSMStoDeviceresponse);
  }
}(this, function(ApiClient, SendSMStoDevicerequest, SendSMStoDeviceresponse) {
  'use strict';
  ...
  var exports = function(apiClient) {
    ...
    /**
     * Callback function to receive the result of the sendSMStoDevice operation.
     * @callback module:api/SMSApi~sendSMStoDeviceCallback
     * @param {String} error Error message, if any.
     * @param {module:model/SendSMStoDeviceresponse} data The data returned by the service call.
     ...
     * @param {module:model/SendSMStoDevicerequest} body 
     * @param {module:api/SMSApi~sendSMStoDeviceCallback} callback The callback function, accepting three arguments: error, data, response
     * data is of type: {@link module:model/SendSMStoDeviceresponse}
     */
    this.sendSMStoDevice = function(contentType, body, callback) {
      var postBody = body;

      // verify the required parameter 'contentType' is set
      if (contentType === undefined || contentType === null) {
        throw new Error("Missing the required parameter 'contentType' when calling sendSMStoDevice");
      }

      // verify the required parameter 'body' is set
      if (body === undefined || body === null) {
        throw new Error("Missing the required parameter 'body' when calling sendSMStoDevice");
      }
      ...
      var returnType = SendSMStoDeviceresponse;

      return this.apiClient.callApi(
        '/api/1/sms/incoming', 'POST',
