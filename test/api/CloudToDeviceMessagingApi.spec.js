...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Hologram.CloudToDeviceMessagingApi();
  });

  describe('(package)', function() {
    describe('CloudToDeviceMessagingApi', function() {
      describe('sendCloudMessagetoDevice', function() {
        it('should call sendCloudMessagetoDevice successfully', function(done) {
          // TODO: uncomment, update parameter values for sendCloudMessagetoDevice call and complete the assertions
          /*
          var contentType = "contentType_example";
          var body = new Hologram.SendCloudMessagetoDevicerequest();
          body.deviceids = [0.0];
          body.protocol = "TCP";
          body.port = 80.0;
          body.data = "Hello world!";
          body.base64data = "SGVsbG8gd29ybGQhCg==";

          instance.sendCloudMessagetoDevice(contentType, body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Hologram.SendCloudMessagetoDeviceresponse);
      ...
      describe('sendCloudMessagetoDeviceviaWebhook', function() {
        it('should call sendCloudMessagetoDeviceviaWebhook successfully', function(done) {
          // TODO: uncomment, update parameter values for sendCloudMessagetoDeviceviaWebhook call and complete the assertions
          /*
          var deviceid = 1.2;
          var webhookguid = "webhookguid_example";
          var contentType = "contentType_example";
          var body = new Hologram.SendCloudMessagetoDeviceviaWebhookrequest();
          body.data = "Hello world!";
          body.base64data = "SGVsbG8gd29ybGQhCg==";

          instance.sendCloudMessagetoDeviceviaWebhook(deviceid, webhookguid, contentType, body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Hologram.SendCloudMessagetoDeviceviaWebhookresponse);
            expect(data.success).to.be.a('boolean');
            expect(data.success).to.be(true);
            {
              let dataCtr = data.data;
