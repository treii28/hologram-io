...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Hologram.DataEngineMessagesApi();
  });

  describe('(package)', function() {
    describe('DataEngineMessagesApi', function() {
      describe('listDataEngineMessages', function() {
        it('should call listDataEngineMessages successfully', function(done) {
          // TODO: uncomment, update parameter values for listDataEngineMessages call and complete the assertions
          /*
          var opts = {};
          opts.deviceid = 1.2;
          ...
          opts.id = 1.2;
          opts.startafter = 1.2;
          opts.devicetagid = 1.2;
          opts.topicname = "topicname_example";
          opts.topicnames = ["topicnames_example"];
          opts.timestart = 1.2;
          opts.timeend = 1.2;
          opts.error = true;
          opts.tagname = "tagname_example";
          opts.tagnames = "tagnames_example";

          instance.listDataEngineMessages(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
      ...
      describe('sendaDataEngineMessage', function() {
        it('should call sendaDataEngineMessage successfully', function(done) {
          // TODO: uncomment, update parameter values for sendaDataEngineMessage call and complete the assertions
          /*
          var contentType = "contentType_example";
          var body = new Hologram.SendaDataEngineMessagerequest();
          body.deviceid = 54321.0;
          body.tags = [""];
          body.data = "Hello, Hologram!";

          instance.sendaDataEngineMessage(contentType, body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Hologram.SendaDataEngineMessageresponse);
