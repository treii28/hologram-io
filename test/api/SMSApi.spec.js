...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Hologram.SMSApi();
  });

  describe('(package)', function() {
    describe('SMSApi', function() {
      describe('sendSMStoDevice', function() {
        it('should call sendSMStoDevice successfully', function(done) {
          // TODO: uncomment, update parameter values for sendSMStoDevice call and complete the assertions
          /*
          var contentType = "contentType_example";
          var body = new Hologram.SendSMStoDevicerequest();
          body.deviceid = 1234.0;
          body.deviceids = [""];
          body.fromnumber = "+1-312-555-1212";
          body.body = "Hello world!";

          instance.sendSMStoDevice(contentType, body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Hologram.SendSMStoDeviceresponse);
