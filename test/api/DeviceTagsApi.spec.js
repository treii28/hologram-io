...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Hologram.DeviceTagsApi();
  });

  describe('(package)', function() {
    describe('DeviceTagsApi', function() {
      describe('addTagtoDevice', function() {
        it('should call addTagtoDevice successfully', function(done) {
          // TODO: uncomment, update parameter values for addTagtoDevice call and complete the assertions
          /*
          var tagid = 1.2;
          var contentType = "contentType_example";
          var body = new Hologram.AddTagtoDevicerequest();
          body.deviceids = [0.0];

          instance.addTagtoDevice(tagid, contentType, body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Hologram.AddTagtoDeviceresponse);
            expect(data.success).to.be.a('boolean');
            expect(data.success).to.be(true);
            expect(data.data).to.be.a(Hologram.DeviceTag);
                  expect(data.data.name).to.be.a('string');
              expect(data.data.name).to.be("My Tag");
              expect(data.data.id).to.be.a('number');
              expect(data.data.id).to.be(123.0);
              {
                let dataCtr = data.data.deviceids;
      ...
      describe('createaDeviceTag', function() {
        it('should call createaDeviceTag successfully', function(done) {
          // TODO: uncomment, update parameter values for createaDeviceTag call and complete the assertions
          /*
          var contentType = "contentType_example";
          var body = new Hologram.CreateaDeviceTagrequest();
          body.name = "My Tag";
          body.deviceids = [""];

          instance.createaDeviceTag(contentType, body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Hologram.CreateaDeviceTagresponse);
            expect(data.success).to.be.a('boolean');
            expect(data.success).to.be(true);
            expect(data.data).to.be.a(Hologram.DeviceTag);
                  expect(data.data.name).to.be.a('string');
      ...
      describe('deleteDeviceTag', function() {
        it('should call deleteDeviceTag successfully', function(done) {
          // TODO: uncomment, update parameter values for deleteDeviceTag call and complete the assertions
          /*
          var tagid = 1.2;

          instance.deleteDeviceTag(tagid, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Hologram.DeleteDeviceTagresponse);
            expect(data.success).to.be.a('boolean');
            expect(data.success).to.be(true);
      ...
      describe('listDeviceTags', function() {
        it('should call listDeviceTags successfully', function(done) {
          // TODO: uncomment, update parameter values for listDeviceTags call and complete the assertions
          /*
          var opts = {};
          opts.orgid = 1.2;
          opts.id = 1.2;
          ...
          instance.listDeviceTags(opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Hologram.ListDeviceTagsresponse);
            expect(data.success).to.be.a('boolean');
            expect(data.success).to.be(true);
            {
              ...
              for (let p in dataCtr) {
                let data = dataCtr[p];
                expect(data).to.be.a(Hologram.DeviceTag);
                expect(data.name).to.be.a('string');
                expect(data.name).to.be("My Tag");
                expect(data.id).to.be.a('number');
                expect(data.id).to.be(123.0);
                {
      ...
      describe('removeTagfromDevice', function() {
        it('should call removeTagfromDevice successfully', function(done) {
          // TODO: uncomment, update parameter values for removeTagfromDevice call and complete the assertions
          /*
          var tagid = 1.2;
          var contentType = "contentType_example";
          var body = new Hologram.RemoveTagfromDevicerequest();
          body.deviceids = [0.0];

          instance.removeTagfromDevice(tagid, contentType, body, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
            // TODO: update response assertions
            expect(data).to.be.a(Hologram.RemoveTagfromDeviceresponse);
            expect(data.success).to.be.a('boolean');
            expect(data.success).to.be(true);
            expect(data.data).to.be.a(Hologram.DeviceTag);
                  expect(data.data.name).to.be.a('string');
