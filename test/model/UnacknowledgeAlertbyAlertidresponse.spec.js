...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UnacknowledgeAlertbyAlertidresponse', function() {
      beforeEach(function() {
        instance = new Hologram.UnacknowledgeAlertbyAlertidresponse();
      });

      it('should create an instance of UnacknowledgeAlertbyAlertidresponse', function() {
        // TODO: update the code to test UnacknowledgeAlertbyAlertidresponse
        expect(instance).to.be.a(Hologram.UnacknowledgeAlertbyAlertidresponse);
      });
