...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Tiers', function() {
      beforeEach(function() {
        instance = new Hologram.Tiers();
      });

      it('should create an instance of Tiers', function() {
        // TODO: update the code to test Tiers
        expect(instance).to.be.a(Hologram.Tiers);
      });

      it('should have the property TIERNAME (base name: "TIERNAME")', function() {
        // TODO: update the code to test the property TIERNAME
        expect(instance).to.have.property('TIERNAME');
        // expect(instance.TIERNAME).to.be(expectedValueLiteral);
      });
