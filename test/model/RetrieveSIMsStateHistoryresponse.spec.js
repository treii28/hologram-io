...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RetrieveSIMsStateHistoryresponse', function() {
      beforeEach(function() {
        instance = new Hologram.RetrieveSIMsStateHistoryresponse();
      });

      it('should create an instance of RetrieveSIMsStateHistoryresponse', function() {
        // TODO: update the code to test RetrieveSIMsStateHistoryresponse
        expect(instance).to.be.a(Hologram.RetrieveSIMsStateHistoryresponse);
      });
