...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('EnableaPublicKeyresponse', function() {
      beforeEach(function() {
        instance = new Hologram.EnableaPublicKeyresponse();
      });

      it('should create an instance of EnableaPublicKeyresponse', function() {
        // TODO: update the code to test EnableaPublicKeyresponse
        expect(instance).to.be.a(Hologram.EnableaPublicKeyresponse);
      });
