...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeviceTag', function() {
      beforeEach(function() {
        instance = new Hologram.DeviceTag();
      });

      it('should create an instance of DeviceTag', function() {
        // TODO: update the code to test DeviceTag
        expect(instance).to.be.a(Hologram.DeviceTag);
      });
