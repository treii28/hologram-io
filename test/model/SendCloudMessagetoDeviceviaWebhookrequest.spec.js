...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendCloudMessagetoDeviceviaWebhookrequest', function() {
      beforeEach(function() {
        instance = new Hologram.SendCloudMessagetoDeviceviaWebhookrequest();
      });

      it('should create an instance of SendCloudMessagetoDeviceviaWebhookrequest', function() {
        // TODO: update the code to test SendCloudMessagetoDeviceviaWebhookrequest
        expect(instance).to.be.a(Hologram.SendCloudMessagetoDeviceviaWebhookrequest);
      });
      ...
      it('should have the property base64data (base name: "base64data")', function() {
        // TODO: update the code to test the property base64data
        expect(instance).to.have.property('base64data');
        // expect(instance.base64data).to.be(expectedValueLiteral);
      });
