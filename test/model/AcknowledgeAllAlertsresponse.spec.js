...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AcknowledgeAllAlertsresponse', function() {
      beforeEach(function() {
        instance = new Hologram.AcknowledgeAllAlertsresponse();
      });

      it('should create an instance of AcknowledgeAllAlertsresponse', function() {
        // TODO: update the code to test AcknowledgeAllAlertsresponse
        expect(instance).to.be.a(Hologram.AcknowledgeAllAlertsresponse);
      });
