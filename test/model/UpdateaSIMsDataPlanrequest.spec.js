...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateaSIMsDataPlanrequest', function() {
      beforeEach(function() {
        instance = new Hologram.UpdateaSIMsDataPlanrequest();
      });

      it('should create an instance of UpdateaSIMsDataPlanrequest', function() {
        // TODO: update the code to test UpdateaSIMsDataPlanrequest
        expect(instance).to.be.a(Hologram.UpdateaSIMsDataPlanrequest);
      });
