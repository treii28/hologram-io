...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Data7', function() {
      beforeEach(function() {
        instance = new Hologram.Data7();
      });

      it('should create an instance of Data7', function() {
        // TODO: update the code to test Data7
        expect(instance).to.be.a(Hologram.Data7);
      });
      ...
      it('should have the property curPeriodEnd (base name: "cur_period_end")', function() {
        // TODO: update the code to test the property curPeriodEnd
        expect(instance).to.have.property('curPeriodEnd');
        // expect(instance.curPeriodEnd).to.be(expectedValueLiteral);
      });

      it('should have the property periodsBack (base name: "periods_back")', function() {
        // TODO: update the code to test the property periodsBack
        expect(instance).to.have.property('periodsBack');
        // expect(instance.periodsBack).to.be(expectedValueLiteral);
      });
