...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ActivateMultipleSIMsbyICCIDrequest', function() {
      beforeEach(function() {
        instance = new Hologram.ActivateMultipleSIMsbyICCIDrequest();
      });

      it('should create an instance of ActivateMultipleSIMsbyICCIDrequest', function() {
        // TODO: update the code to test ActivateMultipleSIMsbyICCIDrequest
        expect(instance).to.be.a(Hologram.ActivateMultipleSIMsbyICCIDrequest);
      });

      it('should have the property sims (base name: "sims")', function() {
        // TODO: update the code to test the property sims
        expect(instance).to.have.property('sims');
        // expect(instance.sims).to.be(expectedValueLiteral);
      });
