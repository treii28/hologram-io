...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PauseorUnpauseDataresponse', function() {
      beforeEach(function() {
        instance = new Hologram.PauseorUnpauseDataresponse();
      });

      it('should create an instance of PauseorUnpauseDataresponse', function() {
        // TODO: update the code to test PauseorUnpauseDataresponse
        expect(instance).to.be.a(Hologram.PauseorUnpauseDataresponse);
      });
