...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('User', function() {
      beforeEach(function() {
        instance = new Hologram.User();
      });

      it('should create an instance of User', function() {
        // TODO: update the code to test User
        expect(instance).to.be.a(Hologram.User);
      });
      ...
      it('should have the property personalOrg (base name: "personal_org")', function() {
        // TODO: update the code to test the property personalOrg
        expect(instance).to.have.property('personalOrg');
        // expect(instance.personalOrg).to.be(expectedValueLiteral);
      });

      it('should have the property billingmethod (base name: "billingmethod")', function() {
        // TODO: update the code to test the property billingmethod
        expect(instance).to.have.property('billingmethod');
        // expect(instance.billingmethod).to.be(expectedValueLiteral);
      });
