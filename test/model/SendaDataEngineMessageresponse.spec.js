...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendaDataEngineMessageresponse', function() {
      beforeEach(function() {
        instance = new Hologram.SendaDataEngineMessageresponse();
      });

      it('should create an instance of SendaDataEngineMessageresponse', function() {
        // TODO: update the code to test SendaDataEngineMessageresponse
        expect(instance).to.be.a(Hologram.SendaDataEngineMessageresponse);
      });
