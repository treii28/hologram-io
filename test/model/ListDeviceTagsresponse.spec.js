...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListDeviceTagsresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListDeviceTagsresponse();
      });

      it('should create an instance of ListDeviceTagsresponse', function() {
        // TODO: update the code to test ListDeviceTagsresponse
        expect(instance).to.be.a(Hologram.ListDeviceTagsresponse);
      });
