...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateSIMsOverageLimitrequest', function() {
      beforeEach(function() {
        instance = new Hologram.UpdateSIMsOverageLimitrequest();
      });

      it('should create an instance of UpdateSIMsOverageLimitrequest', function() {
        // TODO: update the code to test UpdateSIMsOverageLimitrequest
        expect(instance).to.be.a(Hologram.UpdateSIMsOverageLimitrequest);
      });
