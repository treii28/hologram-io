...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TunnelKey', function() {
      beforeEach(function() {
        instance = new Hologram.TunnelKey();
      });

      it('should create an instance of TunnelKey', function() {
        // TODO: update the code to test TunnelKey
        expect(instance).to.be.a(Hologram.TunnelKey);
      });
