...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListOrganizationsresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListOrganizationsresponse();
      });

      it('should create an instance of ListOrganizationsresponse', function() {
        // TODO: update the code to test ListOrganizationsresponse
        expect(instance).to.be.a(Hologram.ListOrganizationsresponse);
      });
