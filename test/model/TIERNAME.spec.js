...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TIERNAME', function() {
      beforeEach(function() {
        instance = new Hologram.TIERNAME();
      });

      it('should create an instance of TIERNAME', function() {
        // TODO: update the code to test TIERNAME
        expect(instance).to.be.a(Hologram.TIERNAME);
      });

      it('should have the property devicecount (base name: "devicecount")', function() {
        // TODO: update the code to test the property devicecount
        expect(instance).to.have.property('devicecount');
        // expect(instance.devicecount).to.be(expectedValueLiteral);
      });
