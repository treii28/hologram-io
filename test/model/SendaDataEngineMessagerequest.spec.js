...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendaDataEngineMessagerequest', function() {
      beforeEach(function() {
        instance = new Hologram.SendaDataEngineMessagerequest();
      });

      it('should create an instance of SendaDataEngineMessagerequest', function() {
        // TODO: update the code to test SendaDataEngineMessagerequest
        expect(instance).to.be.a(Hologram.SendaDataEngineMessagerequest);
      });
