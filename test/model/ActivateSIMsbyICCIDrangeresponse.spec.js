...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ActivateSIMsbyICCIDrangeresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ActivateSIMsbyICCIDrangeresponse();
      });

      it('should create an instance of ActivateSIMsbyICCIDrangeresponse', function() {
        // TODO: update the code to test ActivateSIMsbyICCIDrangeresponse
        expect(instance).to.be.a(Hologram.ActivateSIMsbyICCIDrangeresponse);
      });
