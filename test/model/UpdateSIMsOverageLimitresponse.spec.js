...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateSIMsOverageLimitresponse', function() {
      beforeEach(function() {
        instance = new Hologram.UpdateSIMsOverageLimitresponse();
      });

      it('should create an instance of UpdateSIMsOverageLimitresponse', function() {
        // TODO: update the code to test UpdateSIMsOverageLimitresponse
        expect(instance).to.be.a(Hologram.UpdateSIMsOverageLimitresponse);
      });
