...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetaDataPlanresponse', function() {
      beforeEach(function() {
        instance = new Hologram.GetaDataPlanresponse();
      });

      it('should create an instance of GetaDataPlanresponse', function() {
        // TODO: update the code to test GetaDataPlanresponse
        expect(instance).to.be.a(Hologram.GetaDataPlanresponse);
      });
