...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Data4', function() {
      beforeEach(function() {
        instance = new Hologram.Data4();
      });

      it('should create an instance of Data4', function() {
        // TODO: update the code to test Data4
        expect(instance).to.be.a(Hologram.Data4);
      });
      ...
      it('should have the property imeisv (base name: "imeisv")', function() {
        // TODO: update the code to test the property imeisv
        expect(instance).to.have.property('imeisv');
        // expect(instance.imeisv).to.be(expectedValueLiteral);
      });
