...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AcknowledgeAlertsbyAlertidsresponse', function() {
      beforeEach(function() {
        instance = new Hologram.AcknowledgeAlertsbyAlertidsresponse();
      });

      it('should create an instance of AcknowledgeAlertsbyAlertidsresponse', function() {
        // TODO: update the code to test AcknowledgeAlertsbyAlertidsresponse
        expect(instance).to.be.a(Hologram.AcknowledgeAlertsbyAlertidsresponse);
      });
