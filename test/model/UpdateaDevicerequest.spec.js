...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateaDevicerequest', function() {
      beforeEach(function() {
        instance = new Hologram.UpdateaDevicerequest();
      });

      it('should create an instance of UpdateaDevicerequest', function() {
        // TODO: update the code to test UpdateaDevicerequest
        expect(instance).to.be.a(Hologram.UpdateaDevicerequest);
      });
