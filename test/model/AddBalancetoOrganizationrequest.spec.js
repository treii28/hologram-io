...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddBalancetoOrganizationrequest', function() {
      beforeEach(function() {
        instance = new Hologram.AddBalancetoOrganizationrequest();
      });

      it('should create an instance of AddBalancetoOrganizationrequest', function() {
        // TODO: update the code to test AddBalancetoOrganizationrequest
        expect(instance).to.be.a(Hologram.AddBalancetoOrganizationrequest);
      });

      it('should have the property addamount (base name: "addamount")', function() {
        // TODO: update the code to test the property addamount
        expect(instance).to.have.property('addamount');
        // expect(instance.addamount).to.be(expectedValueLiteral);
      });
