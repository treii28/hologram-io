...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RetrieveaUserresponse', function() {
      beforeEach(function() {
        instance = new Hologram.RetrieveaUserresponse();
      });

      it('should create an instance of RetrieveaUserresponse', function() {
        // TODO: update the code to test RetrieveaUserresponse
        expect(instance).to.be.a(Hologram.RetrieveaUserresponse);
      });
