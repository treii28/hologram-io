...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RemoveTagfromDeviceresponse', function() {
      beforeEach(function() {
        instance = new Hologram.RemoveTagfromDeviceresponse();
      });

      it('should create an instance of RemoveTagfromDeviceresponse', function() {
        // TODO: update the code to test RemoveTagfromDeviceresponse
        expect(instance).to.be.a(Hologram.RemoveTagfromDeviceresponse);
      });
