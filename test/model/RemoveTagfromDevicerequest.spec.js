...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RemoveTagfromDevicerequest', function() {
      beforeEach(function() {
        instance = new Hologram.RemoveTagfromDevicerequest();
      });

      it('should create an instance of RemoveTagfromDevicerequest', function() {
        // TODO: update the code to test RemoveTagfromDevicerequest
        expect(instance).to.be.a(Hologram.RemoveTagfromDevicerequest);
      });
