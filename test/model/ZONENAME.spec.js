...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ZONENAME', function() {
      beforeEach(function() {
        instance = new Hologram.ZONENAME();
      });

      it('should create an instance of ZONENAME', function() {
        // TODO: update the code to test ZONENAME
        expect(instance).to.be.a(Hologram.ZONENAME);
      });
