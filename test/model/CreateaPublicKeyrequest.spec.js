...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateaPublicKeyrequest', function() {
      beforeEach(function() {
        instance = new Hologram.CreateaPublicKeyrequest();
      });

      it('should create an instance of CreateaPublicKeyrequest', function() {
        // TODO: update the code to test CreateaPublicKeyrequest
        expect(instance).to.be.a(Hologram.CreateaPublicKeyrequest);
      });
