...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('GetAlertCountbyTyperesponse', function() {
      beforeEach(function() {
        instance = new Hologram.GetAlertCountbyTyperesponse();
      });

      it('should create an instance of GetAlertCountbyTyperesponse', function() {
        // TODO: update the code to test GetAlertCountbyTyperesponse
        expect(instance).to.be.a(Hologram.GetAlertCountbyTyperesponse);
      });
