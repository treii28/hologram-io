...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendCloudMessagetoDevicerequest', function() {
      beforeEach(function() {
        instance = new Hologram.SendCloudMessagetoDevicerequest();
      });

      it('should create an instance of SendCloudMessagetoDevicerequest', function() {
        // TODO: update the code to test SendCloudMessagetoDevicerequest
        expect(instance).to.be.a(Hologram.SendCloudMessagetoDevicerequest);
      });
