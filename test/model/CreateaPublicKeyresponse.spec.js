...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateaPublicKeyresponse', function() {
      beforeEach(function() {
        instance = new Hologram.CreateaPublicKeyresponse();
      });

      it('should create an instance of CreateaPublicKeyresponse', function() {
        // TODO: update the code to test CreateaPublicKeyresponse
        expect(instance).to.be.a(Hologram.CreateaPublicKeyresponse);
      });
