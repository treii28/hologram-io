...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Zones1', function() {
      beforeEach(function() {
        instance = new Hologram.Zones1();
      });

      it('should create an instance of Zones1', function() {
        // TODO: update the code to test Zones1
        expect(instance).to.be.a(Hologram.Zones1);
      });
