...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DisableaPublicKeyresponse', function() {
      beforeEach(function() {
        instance = new Hologram.DisableaPublicKeyresponse();
      });

      it('should create an instance of DisableaPublicKeyresponse', function() {
        // TODO: update the code to test DisableaPublicKeyresponse
        expect(instance).to.be.a(Hologram.DisableaPublicKeyresponse);
      });
