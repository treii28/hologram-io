...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateaSIMsDataPlanresponse', function() {
      beforeEach(function() {
        instance = new Hologram.UpdateaSIMsDataPlanresponse();
      });

      it('should create an instance of UpdateaSIMsDataPlanresponse', function() {
        // TODO: update the code to test UpdateaSIMsDataPlanresponse
        expect(instance).to.be.a(Hologram.UpdateaSIMsDataPlanresponse);
      });
