...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListUsageDatabyMonthresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListUsageDatabyMonthresponse();
      });

      it('should create an instance of ListUsageDatabyMonthresponse', function() {
        // TODO: update the code to test ListUsageDatabyMonthresponse
        expect(instance).to.be.a(Hologram.ListUsageDatabyMonthresponse);
      });
