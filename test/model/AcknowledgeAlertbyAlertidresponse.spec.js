...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AcknowledgeAlertbyAlertidresponse', function() {
      beforeEach(function() {
        instance = new Hologram.AcknowledgeAlertbyAlertidresponse();
      });

      it('should create an instance of AcknowledgeAlertbyAlertidresponse', function() {
        // TODO: update the code to test AcknowledgeAlertbyAlertidresponse
        expect(instance).to.be.a(Hologram.AcknowledgeAlertbyAlertidresponse);
      });
