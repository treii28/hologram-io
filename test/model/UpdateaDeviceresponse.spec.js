...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateaDeviceresponse', function() {
      beforeEach(function() {
        instance = new Hologram.UpdateaDeviceresponse();
      });

      it('should create an instance of UpdateaDeviceresponse', function() {
        // TODO: update the code to test UpdateaDeviceresponse
        expect(instance).to.be.a(Hologram.UpdateaDeviceresponse);
      });
