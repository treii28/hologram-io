...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAllTACchangealertsresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListAllTACchangealertsresponse();
      });

      it('should create an instance of ListAllTACchangealertsresponse', function() {
        // TODO: update the code to test ListAllTACchangealertsresponse
        expect(instance).to.be.a(Hologram.ListAllTACchangealertsresponse);
      });
