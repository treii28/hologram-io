...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RetrieveaCellularLinkresponse', function() {
      beforeEach(function() {
        instance = new Hologram.RetrieveaCellularLinkresponse();
      });

      it('should create an instance of RetrieveaCellularLinkresponse', function() {
        // TODO: update the code to test RetrieveaCellularLinkresponse
        expect(instance).to.be.a(Hologram.RetrieveaCellularLinkresponse);
      });
