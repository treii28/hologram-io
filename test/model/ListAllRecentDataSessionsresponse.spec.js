...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAllRecentDataSessionsresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListAllRecentDataSessionsresponse();
      });

      it('should create an instance of ListAllRecentDataSessionsresponse', function() {
        // TODO: update the code to test ListAllRecentDataSessionsresponse
        expect(instance).to.be.a(Hologram.ListAllRecentDataSessionsresponse);
      });
