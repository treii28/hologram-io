...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ActivateSingleSIMbyICCIDresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ActivateSingleSIMbyICCIDresponse();
      });

      it('should create an instance of ActivateSingleSIMbyICCIDresponse', function() {
        // TODO: update the code to test ActivateSingleSIMbyICCIDresponse
        expect(instance).to.be.a(Hologram.ActivateSingleSIMbyICCIDresponse);
      });
