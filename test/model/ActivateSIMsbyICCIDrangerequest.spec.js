...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ActivateSIMsbyICCIDrangerequest', function() {
      beforeEach(function() {
        instance = new Hologram.ActivateSIMsbyICCIDrangerequest();
      });

      it('should create an instance of ActivateSIMsbyICCIDrangerequest', function() {
        // TODO: update the code to test ActivateSIMsbyICCIDrangerequest
        expect(instance).to.be.a(Hologram.ActivateSIMsbyICCIDrangerequest);
      });

      it('should have the property simrange (base name: "simrange")', function() {
        // TODO: update the code to test the property simrange
        expect(instance).to.have.property('simrange');
        // expect(instance.simrange).to.be(expectedValueLiteral);
      });
