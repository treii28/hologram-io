...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RetrieveanOrganizationresponse', function() {
      beforeEach(function() {
        instance = new Hologram.RetrieveanOrganizationresponse();
      });

      it('should create an instance of RetrieveanOrganizationresponse', function() {
        // TODO: update the code to test RetrieveanOrganizationresponse
        expect(instance).to.be.a(Hologram.RetrieveanOrganizationresponse);
      });
