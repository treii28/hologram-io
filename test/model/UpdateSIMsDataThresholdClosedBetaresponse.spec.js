...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateSIMsDataThresholdClosedBetaresponse', function() {
      beforeEach(function() {
        instance = new Hologram.UpdateSIMsDataThresholdClosedBetaresponse();
      });

      it('should create an instance of UpdateSIMsDataThresholdClosedBetaresponse', function() {
        // TODO: update the code to test UpdateSIMsDataThresholdClosedBetaresponse
        expect(instance).to.be.a(Hologram.UpdateSIMsDataThresholdClosedBetaresponse);
      });
