...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAllDeviceDataLimitalertsresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListAllDeviceDataLimitalertsresponse();
      });

      it('should create an instance of ListAllDeviceDataLimitalertsresponse', function() {
        // TODO: update the code to test ListAllDeviceDataLimitalertsresponse
        expect(instance).to.be.a(Hologram.ListAllDeviceDataLimitalertsresponse);
      });
