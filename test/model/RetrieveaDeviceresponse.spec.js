...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RetrieveaDeviceresponse', function() {
      beforeEach(function() {
        instance = new Hologram.RetrieveaDeviceresponse();
      });

      it('should create an instance of RetrieveaDeviceresponse', function() {
        // TODO: update the code to test RetrieveaDeviceresponse
        expect(instance).to.be.a(Hologram.RetrieveaDeviceresponse);
      });
