...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddBalancetoOrganizationresponse', function() {
      beforeEach(function() {
        instance = new Hologram.AddBalancetoOrganizationresponse();
      });

      it('should create an instance of AddBalancetoOrganizationresponse', function() {
        // TODO: update the code to test AddBalancetoOrganizationresponse
        expect(instance).to.be.a(Hologram.AddBalancetoOrganizationresponse);
      });
      ...
      it('should have the property orderData (base name: "order_data")', function() {
        // TODO: update the code to test the property orderData
        expect(instance).to.have.property('orderData');
        // expect(instance.orderData).to.be(expectedValueLiteral);
      });
