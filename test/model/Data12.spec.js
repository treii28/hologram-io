...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Data12', function() {
      beforeEach(function() {
        instance = new Hologram.Data12();
      });

      it('should create an instance of Data12', function() {
        // TODO: update the code to test Data12
        expect(instance).to.be.a(Hologram.Data12);
      });
      ...
      it('should have the property transactiontypeid (base name: "transactiontypeid")', function() {
        // TODO: update the code to test the property transactiontypeid
        expect(instance).to.have.property('transactiontypeid');
        // expect(instance.transactiontypeid).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property linkids (base name: "linkids")', function() {
        // TODO: update the code to test the property linkids
        expect(instance).to.have.property('linkids');
        // expect(instance.linkids).to.be(expectedValueLiteral);
      });
