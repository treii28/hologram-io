...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddTagtoDeviceresponse', function() {
      beforeEach(function() {
        instance = new Hologram.AddTagtoDeviceresponse();
      });

      it('should create an instance of AddTagtoDeviceresponse', function() {
        // TODO: update the code to test AddTagtoDeviceresponse
        expect(instance).to.be.a(Hologram.AddTagtoDeviceresponse);
      });
