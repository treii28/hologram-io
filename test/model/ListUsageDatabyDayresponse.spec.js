...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListUsageDatabyDayresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListUsageDatabyDayresponse();
      });

      it('should create an instance of ListUsageDatabyDayresponse', function() {
        // TODO: update the code to test ListUsageDatabyDayresponse
        expect(instance).to.be.a(Hologram.ListUsageDatabyDayresponse);
      });
