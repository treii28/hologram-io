...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AddTagtoDevicerequest', function() {
      beforeEach(function() {
        instance = new Hologram.AddTagtoDevicerequest();
      });

      it('should create an instance of AddTagtoDevicerequest', function() {
        // TODO: update the code to test AddTagtoDevicerequest
        expect(instance).to.be.a(Hologram.AddTagtoDevicerequest);
      });
