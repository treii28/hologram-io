...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AccountBalance', function() {
      beforeEach(function() {
        instance = new Hologram.AccountBalance();
      });

      it('should create an instance of AccountBalance', function() {
        // TODO: update the code to test AccountBalance
        expect(instance).to.be.a(Hologram.AccountBalance);
      });
      ...
      it('should have the property promobalance (base name: "promobalance")', function() {
        // TODO: update the code to test the property promobalance
        expect(instance).to.have.property('promobalance');
        // expect(instance.promobalance).to.be(expectedValueLiteral);
      });

      it('should have the property minbalance (base name: "minbalance")', function() {
        // TODO: update the code to test the property minbalance
        expect(instance).to.have.property('minbalance');
        // expect(instance.minbalance).to.be(expectedValueLiteral);
      });

      it('should have the property topoffamount (base name: "topoffamount")', function() {
        // TODO: update the code to test the property topoffamount
        expect(instance).to.have.property('topoffamount');
        // expect(instance.topoffamount).to.be(expectedValueLiteral);
      });

      it('should have the property pendingcharges (base name: "pendingcharges")', function() {
        // TODO: update the code to test the property pendingcharges
        expect(instance).to.have.property('pendingcharges');
        // expect(instance.pendingcharges).to.be(expectedValueLiteral);
      });
