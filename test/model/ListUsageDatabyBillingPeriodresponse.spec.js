...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListUsageDatabyBillingPeriodresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListUsageDatabyBillingPeriodresponse();
      });

      it('should create an instance of ListUsageDatabyBillingPeriodresponse', function() {
        // TODO: update the code to test ListUsageDatabyBillingPeriodresponse
        expect(instance).to.be.a(Hologram.ListUsageDatabyBillingPeriodresponse);
      });
