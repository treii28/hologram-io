...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendCloudMessagetoDeviceviaWebhookresponse', function() {
      beforeEach(function() {
        instance = new Hologram.SendCloudMessagetoDeviceviaWebhookresponse();
      });

      it('should create an instance of SendCloudMessagetoDeviceviaWebhookresponse', function() {
        // TODO: update the code to test SendCloudMessagetoDeviceviaWebhookresponse
        expect(instance).to.be.a(Hologram.SendCloudMessagetoDeviceviaWebhookresponse);
      });
