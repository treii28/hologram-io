...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ActivateSingleSIMbyICCIDrequest', function() {
      beforeEach(function() {
        instance = new Hologram.ActivateSingleSIMbyICCIDrequest();
      });

      it('should create an instance of ActivateSingleSIMbyICCIDrequest', function() {
        // TODO: update the code to test ActivateSingleSIMbyICCIDrequest
        expect(instance).to.be.a(Hologram.ActivateSingleSIMbyICCIDrequest);
      });
