...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendSMStoDevicerequest', function() {
      beforeEach(function() {
        instance = new Hologram.SendSMStoDevicerequest();
      });

      it('should create an instance of SendSMStoDevicerequest', function() {
        // TODO: update the code to test SendSMStoDevicerequest
        expect(instance).to.be.a(Hologram.SendSMStoDevicerequest);
      });
