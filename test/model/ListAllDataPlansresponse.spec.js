...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAllDataPlansresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListAllDataPlansresponse();
      });

      it('should create an instance of ListAllDataPlansresponse', function() {
        // TODO: update the code to test ListAllDataPlansresponse
        expect(instance).to.be.a(Hologram.ListAllDataPlansresponse);
      });
