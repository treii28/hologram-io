...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAllUsagealertsresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListAllUsagealertsresponse();
      });

      it('should create an instance of ListAllUsagealertsresponse', function() {
        // TODO: update the code to test ListAllUsagealertsresponse
        expect(instance).to.be.a(Hologram.ListAllUsagealertsresponse);
      });
