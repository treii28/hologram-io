...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAllCustomalertsresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListAllCustomalertsresponse();
      });

      it('should create an instance of ListAllCustomalertsresponse', function() {
        // TODO: update the code to test ListAllCustomalertsresponse
        expect(instance).to.be.a(Hologram.ListAllCustomalertsresponse);
      });
