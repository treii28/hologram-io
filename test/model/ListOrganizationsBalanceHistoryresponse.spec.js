...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListOrganizationsBalanceHistoryresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListOrganizationsBalanceHistoryresponse();
      });

      it('should create an instance of ListOrganizationsBalanceHistoryresponse', function() {
        // TODO: update the code to test ListOrganizationsBalanceHistoryresponse
        expect(instance).to.be.a(Hologram.ListOrganizationsBalanceHistoryresponse);
      });
