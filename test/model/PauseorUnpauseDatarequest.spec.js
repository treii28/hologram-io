...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PauseorUnpauseDatarequest', function() {
      beforeEach(function() {
        instance = new Hologram.PauseorUnpauseDatarequest();
      });

      it('should create an instance of PauseorUnpauseDatarequest', function() {
        // TODO: update the code to test PauseorUnpauseDatarequest
        expect(instance).to.be.a(Hologram.PauseorUnpauseDatarequest);
      });
