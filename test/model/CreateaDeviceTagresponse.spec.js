...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateaDeviceTagresponse', function() {
      beforeEach(function() {
        instance = new Hologram.CreateaDeviceTagresponse();
      });

      it('should create an instance of CreateaDeviceTagresponse', function() {
        // TODO: update the code to test CreateaDeviceTagresponse
        expect(instance).to.be.a(Hologram.CreateaDeviceTagresponse);
      });
