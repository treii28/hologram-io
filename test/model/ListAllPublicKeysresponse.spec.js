...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAllPublicKeysresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListAllPublicKeysresponse();
      });

      it('should create an instance of ListAllPublicKeysresponse', function() {
        // TODO: update the code to test ListAllPublicKeysresponse
        expect(instance).to.be.a(Hologram.ListAllPublicKeysresponse);
      });
