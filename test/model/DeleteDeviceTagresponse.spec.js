...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DeleteDeviceTagresponse', function() {
      beforeEach(function() {
        instance = new Hologram.DeleteDeviceTagresponse();
      });

      it('should create an instance of DeleteDeviceTagresponse', function() {
        // TODO: update the code to test DeleteDeviceTagresponse
        expect(instance).to.be.a(Hologram.DeleteDeviceTagresponse);
      });
