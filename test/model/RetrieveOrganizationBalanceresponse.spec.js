...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RetrieveOrganizationBalanceresponse', function() {
      beforeEach(function() {
        instance = new Hologram.RetrieveOrganizationBalanceresponse();
      });

      it('should create an instance of RetrieveOrganizationBalanceresponse', function() {
        // TODO: update the code to test RetrieveOrganizationBalanceresponse
        expect(instance).to.be.a(Hologram.RetrieveOrganizationBalanceresponse);
      });
