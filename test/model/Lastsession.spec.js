...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Lastsession', function() {
      beforeEach(function() {
        instance = new Hologram.Lastsession();
      });

      it('should create an instance of Lastsession', function() {
        // TODO: update the code to test Lastsession
        expect(instance).to.be.a(Hologram.Lastsession);
      });
      ...
      it('should have the property sessionBegin (base name: "session_begin")', function() {
        // TODO: update the code to test the property sessionBegin
        expect(instance).to.have.property('sessionBegin');
        // expect(instance.sessionBegin).to.be(expectedValueLiteral);
      });

      it('should have the property sessionEnd (base name: "session_end")', function() {
        // TODO: update the code to test the property sessionEnd
        expect(instance).to.have.property('sessionEnd');
        // expect(instance.sessionEnd).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property tadig (base name: "tadig")', function() {
        // TODO: update the code to test the property tadig
        expect(instance).to.have.property('tadig');
        // expect(instance.tadig).to.be(expectedValueLiteral);
      });

      it('should have the property lac (base name: "lac")', function() {
        // TODO: update the code to test the property lac
        expect(instance).to.have.property('lac');
        // expect(instance.lac).to.be(expectedValueLiteral);
      });
      ...
      it('should have the property radioAccessTechnology (base name: "radio_access_technology")', function() {
        // TODO: update the code to test the property radioAccessTechnology
        expect(instance).to.have.property('radioAccessTechnology');
        // expect(instance.radioAccessTechnology).to.be(expectedValueLiteral);
      });
