...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ActivateMultipleSIMsbyICCIDresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ActivateMultipleSIMsbyICCIDresponse();
      });

      it('should create an instance of ActivateMultipleSIMsbyICCIDresponse', function() {
        // TODO: update the code to test ActivateMultipleSIMsbyICCIDresponse
        expect(instance).to.be.a(Hologram.ActivateMultipleSIMsbyICCIDresponse);
      });
