...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateaDeviceTagrequest', function() {
      beforeEach(function() {
        instance = new Hologram.CreateaDeviceTagrequest();
      });

      it('should create an instance of CreateaDeviceTagrequest', function() {
        // TODO: update the code to test CreateaDeviceTagrequest
        expect(instance).to.be.a(Hologram.CreateaDeviceTagrequest);
      });
