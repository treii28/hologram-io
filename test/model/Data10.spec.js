...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Data10', function() {
      beforeEach(function() {
        instance = new Hologram.Data10();
      });

      it('should create an instance of Data10', function() {
        // TODO: update the code to test Data10
        expect(instance).to.be.a(Hologram.Data10);
      });
