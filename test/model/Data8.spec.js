...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Data8', function() {
      beforeEach(function() {
        instance = new Hologram.Data8();
      });

      it('should create an instance of Data8', function() {
        // TODO: update the code to test Data8
        expect(instance).to.be.a(Hologram.Data8);
      });
