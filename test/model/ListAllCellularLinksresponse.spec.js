...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAllCellularLinksresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListAllCellularLinksresponse();
      });

      it('should create an instance of ListAllCellularLinksresponse', function() {
        // TODO: update the code to test ListAllCellularLinksresponse
        expect(instance).to.be.a(Hologram.ListAllCellularLinksresponse);
      });
