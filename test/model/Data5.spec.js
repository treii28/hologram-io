...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('Data5', function() {
      beforeEach(function() {
        instance = new Hologram.Data5();
      });

      it('should create an instance of Data5', function() {
        // TODO: update the code to test Data5
        expect(instance).to.be.a(Hologram.Data5);
      });
      ...
      it('should have the property sessionCount (base name: "session_count")', function() {
        // TODO: update the code to test the property sessionCount
        expect(instance).to.have.property('sessionCount');
        // expect(instance.sessionCount).to.be(expectedValueLiteral);
      });
