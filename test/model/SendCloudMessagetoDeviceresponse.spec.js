...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendCloudMessagetoDeviceresponse', function() {
      beforeEach(function() {
        instance = new Hologram.SendCloudMessagetoDeviceresponse();
      });

      it('should create an instance of SendCloudMessagetoDeviceresponse', function() {
        // TODO: update the code to test SendCloudMessagetoDeviceresponse
        expect(instance).to.be.a(Hologram.SendCloudMessagetoDeviceresponse);
      });
