...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('ListAllDevicesresponse', function() {
      beforeEach(function() {
        instance = new Hologram.ListAllDevicesresponse();
      });

      it('should create an instance of ListAllDevicesresponse', function() {
        // TODO: update the code to test ListAllDevicesresponse
        expect(instance).to.be.a(Hologram.ListAllDevicesresponse);
      });
