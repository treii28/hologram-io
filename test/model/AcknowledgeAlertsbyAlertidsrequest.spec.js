...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AcknowledgeAlertsbyAlertidsrequest', function() {
      beforeEach(function() {
        instance = new Hologram.AcknowledgeAlertsbyAlertidsrequest();
      });

      it('should create an instance of AcknowledgeAlertsbyAlertidsrequest', function() {
        // TODO: update the code to test AcknowledgeAlertsbyAlertidsrequest
        expect(instance).to.be.a(Hologram.AcknowledgeAlertsbyAlertidsrequest);
      });

      it('should have the property alertIds (base name: "alertIds")', function() {
        // TODO: update the code to test the property alertIds
        expect(instance).to.have.property('alertIds');
        // expect(instance.alertIds).to.be(expectedValueLiteral);
      });
