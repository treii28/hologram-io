...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DataPlan', function() {
      beforeEach(function() {
        instance = new Hologram.DataPlan();
      });

      it('should create an instance of DataPlan', function() {
        // TODO: update the code to test DataPlan
        expect(instance).to.be.a(Hologram.DataPlan);
      });
      ...
      it('should have the property developerplan (base name: "developerplan")', function() {
        // TODO: update the code to test the property developerplan
        expect(instance).to.have.property('developerplan');
        // expect(instance.developerplan).to.be(expectedValueLiteral);
      });

      it('should have the property tiers (base name: "tiers")', function() {
        // TODO: update the code to test the property tiers
        expect(instance).to.have.property('tiers');
        // expect(instance.tiers).to.be(expectedValueLiteral);
      });

      it('should have the property currentTier (base name: "current_tier")', function() {
        // TODO: update the code to test the property currentTier
        expect(instance).to.have.property('currentTier');
        // expect(instance.currentTier).to.be(expectedValueLiteral);
      });
