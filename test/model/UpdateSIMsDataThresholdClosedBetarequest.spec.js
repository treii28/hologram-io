...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('UpdateSIMsDataThresholdClosedBetarequest', function() {
      beforeEach(function() {
        instance = new Hologram.UpdateSIMsDataThresholdClosedBetarequest();
      });

      it('should create an instance of UpdateSIMsDataThresholdClosedBetarequest', function() {
        // TODO: update the code to test UpdateSIMsDataThresholdClosedBetarequest
        expect(instance).to.be.a(Hologram.UpdateSIMsDataThresholdClosedBetarequest);
      });

      it('should have the property datathreshold (base name: "datathreshold")', function() {
        // TODO: update the code to test the property datathreshold
        expect(instance).to.have.property('datathreshold');
        // expect(instance.datathreshold).to.be(expectedValueLiteral);
      });
