...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SendSMStoDeviceresponse', function() {
      beforeEach(function() {
        instance = new Hologram.SendSMStoDeviceresponse();
      });

      it('should create an instance of SendSMStoDeviceresponse', function() {
        // TODO: update the code to test SendSMStoDeviceresponse
        expect(instance).to.be.a(Hologram.SendSMStoDeviceresponse);
      });
