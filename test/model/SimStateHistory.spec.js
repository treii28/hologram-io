...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('SimStateHistory', function() {
      beforeEach(function() {
        instance = new Hologram.SimStateHistory();
      });

      it('should create an instance of SimStateHistory', function() {
        // TODO: update the code to test SimStateHistory
        expect(instance).to.be.a(Hologram.SimStateHistory);
      });
      ...
      it('should have the property oldstate (base name: "oldstate")', function() {
        // TODO: update the code to test the property oldstate
        expect(instance).to.have.property('oldstate');
        // expect(instance.oldstate).to.be(expectedValueLiteral);
      });

      it('should have the property newstate (base name: "newstate")', function() {
        // TODO: update the code to test the property newstate
        expect(instance).to.have.property('newstate');
        // expect(instance.newstate).to.be(expectedValueLiteral);
      });
